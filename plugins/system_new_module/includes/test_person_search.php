...
if (isset($mode) && ($mode == 'search' || $mode == 'paginate') && isset($searchkey) && ($searchkey)) {
    ...
    $sql = "SELECT pid, CONCAT(UPPER(name_last),', ') as name_last, CONCAT(name_first,' ', name_2) AS name_first, date_birth, addr_zip, sex, death_date, status FROM " . $fromwhere . $sql3;
		...
		<tr bgcolor="#66ee66" background="' . $root_path . 'gui/img/common/default/tableHeaderbg.gif">';
            ...
            while ($zeile = $ergebnis->FetchRow()) {
                ...
                if ($zeile['status'] == '' || $zeile['status'] == 'normal') {
                    ...
                    if ($zeile['death_date'] && $zeile['death_date'] != '0000-00-00')
