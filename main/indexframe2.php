...
<BODY  marginwidth=0 marginheight=0 topmargin=0 leftmargin=0 onUnload="killmenu()" onLoad="if (window.focus)
            window.focus();
<?php if ($boot)
    echo 'window.parent.CONTENTS.location.replace(\'startframe.php?sid=' . $sid . '&lang=' . $lang . '&cookie=' . $cookie . '\') ';
?>
       "
       <?php
