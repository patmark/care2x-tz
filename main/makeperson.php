...
# default to male sex
if (isset($sex) && empty($sex) || ($sex != 'm' && $sex != 'f'))
    $sex = 'm';
...
if ($pool = $db->Execute($sql1)) {
    if ($poolcount = $pool->RecordCount()) {
        ...
        for ($x = 0, $n = 0; $x < $inmax; $x++, $n++) {
            ...
            $rd3 = rand(1, 4);
            switch ($rd3) {
                case 1: $blood_group = 'A';
                    break;
                case 2: $blood_group = 'B';
                    break;
                case 3: $blood_group = 'O';
                    break;
            ...
            $rd4 = rand(1, 5);
            switch ($rd4) {
                case 4: $civil_status = 'single';
                    break;
                case 2: $civil_status = 'married';
                    break;
                case 3: $civil_status = 'divorced';
                    break;
                case 1: $civil_status = 'widowed';
                    break;
