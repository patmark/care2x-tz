        ...
        <tr>
            <td valign=top bgcolor=#cde1ec colspan=2><p><br>
                <ul>
                    ...
                    <img <?php echo createComIcon($root_path, 'varrow.gif', '0') ?>> <a href="op-pflege-dienst-schnellsicht.php">Schnell�bersicht �ber die gegenw�rtige diensthabende OP Pfleger</a><br>
