...
if (($cfg['mask'] == 1) || ($cfg['mask'] == ''))
    $smarty->assign('LDDisplay', '<a href="' . $root_path . 'index.php' . URL_APPEND . $sMask . '" target="_top">' . $LDDisplay2 . '</a>');
else
    $smarty->assign('LDDisplay', '<a href="' . $root_path . 'index.php' . URL_APPEND . $sMask . '" target="_top">' . $LDDisplay1 . '</a>');
...
if (($cfg['mask'] == 1) || ($cfg['mask'] == ''))
    $smarty->assign('LDDisplayTxt', $LDDisplay2Txt);
else
    $smarty->assign('LDDisplayTxt', $LDDisplay1Txt);
...
if (($cfg['mask'] == 1) || ($cfg['mask'] == ''))
    $smarty->assign('LDDisplayImg', '<a href="' . $root_path . 'index.php' . URL_APPEND . $sMask . '" target="_top"><img ' . createComIcon($root_path, 'redirects.gif', '0', '', FALSE) . '></a>');
else
    $smarty->assign('LDDisplayImg', '<a href="' . $root_path . 'index.php' . URL_APPEND . $sMask . '" target="_top"><img ' . createComIcon($root_path, 'redirects.gif', '0', '', FALSE) . '></a>');
