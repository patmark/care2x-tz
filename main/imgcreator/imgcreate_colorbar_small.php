...
if (!isset($result['yellow']))
    $result = array('yellow' => 0, 'black' => 0, 'blue_pale' => 0, 'brown' => 0, 'pink' => 0, 'yellow_pale' => 0, 'red' => 0, 'green_pale' => 0, 'violet' => 0, 'blue' => 0, 'biege' => 0, 'orange' => 0);
...
/* Draw the color bars */
if ($result['yellow'] == 2)
    ImageFilledRectangle($label, 0, 0, 4, $bot, $yellow);
else
    ImageFilledRectangle($label, 0, $ltop, 4, $bot, $yellow);
if ($result['black'] == 2)
    ImageFilledRectangle($label, 5, 0, 9, $bot, $black);
else
    ImageFilledRectangle($label, 5, $ltop, 9, $bot, $black);
if ($result['blue_pale'] == 2)
    ImageFilledRectangle($label, 10, 0, 14, $bot, $blue_pale);
else
    ImageFilledRectangle($label, 10, $ltop, 14, $bot, $blue_pale);
if ($result['brown'] == 2)
    ImageFilledRectangle($label, 15, 0, 19, $bot, $brown);
else
    ImageFilledRectangle($label, 15, $ltop, 19, $bot, $brown);
if ($result['pink'] == 2)
    ImageFilledRectangle($label, 20, 0, 24, $bot, $pink);
else
    ImageFilledRectangle($label, 20, $ltop, 24, $bot, $pink);
if ($result['yellow_pale'] == 2)
    ImageFilledRectangle($label, 25, 0, 29, $bot, $yellow_pale);
else
    ImageFilledRectangle($label, 25, $ltop, 29, $bot, $yellow_pale);
if ($result['red'] == 2)
    ImageFilledRectangle($label, 30, 0, 34, $bot, $red);
else
