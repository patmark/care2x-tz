...
if ($ttf_render) {
    ...
    ImageTTFText($im, 12, 0, 10, 80, $black, $arial, $result['name_last'] . ', ' . ucwords($result['name_first']));
...
if ($result['payer_other'] == '') {
    if ($ttf_render) {
        ImageTTFText($im, 12, 0, 10, 170, $black, $arial, $result['name_last'] . ', ' . ucwords($result['name_first']));
...
if ($ttf_ok) {
    ...
    ImageTTFText($label2, 11, 0, 10, 75, $black, $arial, ucwords($result['name_first']));
...
if ($ttf_ok) {
    ...
    ImageTTFText($label3, 12, 0, 10, 49, $black, $arial, ucwords($result['name_first']));
