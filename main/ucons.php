...
if (!isset($lang))
    ...
    elseif (isset($_POST['lang']))
        $lang = $_POST['lang'];
    elseif (isset($_COOKIE['ck_lang']))
        $lang = $_COOKIE['ck_lang'];
    else
        $lang = "en";
...
<BODY bgcolor="#ffffff">
    <P><br>
        ...
        <?php
        switch ($lang) {
            case "de": echo '... wird noch weiter ausgebaut.';
                break;
            case "it": echo 'Ancora un po\' di pazienza, ci siamo lavorando.';
                break;
            case "id": echo 'Kami sedan mengerjakan bagian ini. Harap bersabar';
                break;
            case "es": echo 'Estamos trabajando en este m�dulo.  Por favor, sea paciente';
                break;
