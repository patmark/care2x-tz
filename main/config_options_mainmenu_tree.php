                ...
                if ($theme != '.' && $theme != '..') {
                    if (is_dir($filepath . $theme) && file_exists($filepath . $theme . '/tags.php')) {
                        ...
                        <tr class="submenu">
                            ...
                            <td>&nbsp;
                                <?php
                                if (isset($sMainMenuStyleDescriptionLang[$lang]) && !empty($sMainMenuStyleDescriptionLang[$lang]))
                                    echo $sMainMenuStyleDescriptionLang[$lang];
                                else
                                    echo $sMainMenuStyleDescription;
                                ?></td>
