...
--
-- Table structure for table `care_test_sample_quality`
--

CREATE TABLE `care_test_sample_quality` (
  `sample_qualityid` tinyint(1) NOT NULL,
  `sample_quality` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `care_test_sample_quality`
--

INSERT INTO `care_test_sample_quality` (`sample_qualityid`, `sample_quality`) VALUES
(1, 'Suitable'),
(2, 'Unsuitable');
...
--
-- Indexes for table `care_test_sample_quality`
--
ALTER TABLE `care_test_sample_quality`
  ADD PRIMARY KEY (`sample_qualityid`);
...
--
-- AUTO_INCREMENT for table `care_test_sample_quality`
--
ALTER TABLE `care_test_sample_quality`
  MODIFY `sample_qualityid` tinyint(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
