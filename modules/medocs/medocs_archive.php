...
if (isset($mode) && ($mode == 'search')) {
    ...
    if ($dblink_ok) {
        ...
        $select = "SELECT UPPER(p.name_last) as name_last, CONCAT(p.name_first,' ', p.name_2) AS name_first,p.date_birth,e.encounter_nr,e.encounter_class_nr,e.is_discharged,e.encounter_date FROM ";
