...
if (!$personell_nr && !$pid) {
    ?>
          onLoad="if (document.searchform.searchkey.focus)
                        ...
                        <form method="post" action="<?php echo $thisfile; ?>" name="aufnahmeform" onSubmit="return chkForm(this)">
                            ...
                            <table border="0" cellspacing=1 cellpadding=0 width=450>
                                ...
                                <tr>
                                    ...
                                    <td bgcolor="#ffffee">&nbsp;<FONT color="#800000"><?php
                                        if ($sex == 'm')
                                            echo $LDMale;
                                        elseif ($sex == 'f')
                                            echo $LDFemale;
                                ...
                                <tr>
                                    <td class="adm_item"><?php echo $LDpractitionerno; ?>:
                                    </td>
                                    <td colspan=2 class="adm_input"><input name="practitionerno" type="text" size="30"  maxlength="10" value="<?php echo $practitionerno; ?>" >
                                    </td>
                                </tr>
                            ...
                            <!-- <input name="nr_dependent" type="text" size="30" value="<?php //if($nr_dependent) echo $nr_dependent;       ?>" > -->
                                ...
                                <tr>
                                    ...
                                    <td colspan=2 class="adm_input"><input  name="encoder" type="text" value="<?php
                                                                            if ($create_id)
                                                                                echo $create_id;
                                                                            else
