        ...
        <td colspan=3>
            ...
            <p>
                ...
                <a href="person_register.php<?php echo URL_APPEND ?>&pid=<?php echo $pid ?>&update=1"><img 
                    ...
                    <?php
                    if ($personell->Exists($pid)) {
                        $personell_nr = $personell->Exists($pid);
                        ?>
                    <a href="personell_register_show.php<?php echo URL_APPEND ?>&personell_nr=<?php echo $personell_nr ?>&target=personell_reg"><img <?php echo createLDImgSrc($root_path, 'employment_data.gif', '0', 'absmiddle') ?>></a>
                    <?php
