<?php
if (($station == "") || ($rt == NULL) || ($rt != "pflege") || ($sid == NULL) || ($sid != $$ck_sid_buffer)) {
                    ...
                    for ($i = $statdata['startnumber']; $i <= $statdata['endnumber']; $i++) {
                        for ($j = 'a'; $j <= 'b'; $j++) {
                            ...
                            switch (strtolower($helper[0])) {
                                case "fr.": echo '<img src="../img/mans-red.gif">';
                                    break;
                                case "frau": echo '<img src="../img/mans-red.gif">';
                                    break;
                                case "hr.": echo '<img src="../img/mans-gr.gif">';
                                    break;
                                case "herr": echo '<img src="../img/mans-gr.gif">';
                                    break;
                                case "gesperrt": echo '<img src="../img/suspend.gif">';
                                    break;
                                default: echo '<img src="../img/plus2.gif" border=0 alt="Bett ist unbelegt">';
                                    break;
                            }
                            echo "\r\n</td>";
                            echo '<td><font face="verdana,arial" size="2" ><a href="#" onClick=';
                            if ($buf[0] != "!")
                                echo 'getinfo(\'' . $buf[0] . '\',\'' . $buf2 . '\') title="Click f�r mehr Info">';
                            else
                                echo 'unlock(\'' . strtoupper($j) . '\',\'' . $i . '\') title="Click f�r Info bzw. zum Aufheben der Sperre.">'; //$j=bed   $i=room number
