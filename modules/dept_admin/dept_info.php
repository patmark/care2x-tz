        ...
        <table border=0 cellpadding=4>
            <tbody class="submenu">
                ...
                <tr>
                    ...
                    <td class=pblock><?php
                        if (isset($$dept_info['LD_var']) && !empty($$dept_info['LD_var']))
                            echo $$dept_info['LD_var'];
                        else
                            echo $dept_info['name'];
                        ?>
                    </td>
                ...
                <tr>
                    ...
                    <td class=pblock><?php
                        if ($dept['is_sub_dept']) {
                            ...
                            if (isset($$info['LD_var']) && !empty($$info['LD_var']))
                                echo $$info['LD_var'];
                            else
                ...
                <tr>
                    ...
                    <td class=pblock><?php echo $dept['max_appointments'] ?>
                    </td>
                </tr> 
...
if (file_exists($root_path . 'gui/img/logos_dept/dept_' . $dept_nr . '.' . $dept['logo_mime_type']))
    echo '<img src="' . $root_path . 'gui/img/logos_dept/dept_' . $dept_nr . '.' . $dept['logo_mime_type'] . '">';
?>
                    </td>
                </tr>
            </tbody>
