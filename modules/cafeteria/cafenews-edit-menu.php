...
<body onLoad="document.menuform.menuplan.focus()">
    ...
    <?php
    switch ($week) {
        case 1: echo $LDThisWeek;
            break;
        case 2: echo $LDNextWeek;
            break;
        case 3: echo $LD3rdWeek;
            break;
    }
    ?>
                                </font>
...
for ($i = 0, $acttag = $day, $dyidx = $daytag - 1; $i < 7; $i++, $acttag++, $dyidx++) {
    ...
    if ($spot)
        ...
        echo 'cafenews-edit-menu.php' . URL_APPEND . '&week=' . $week . '&myear=' . $year . '&mmonth=' . $month . '&mday=' . $acttag . '" ';
