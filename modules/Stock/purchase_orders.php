    ...
    if ($st != 'received' && $st != 'attended') {
        ?> <a href='purchase_orders.php?del_order=$o'><IMG src='includes/images/delete.png' border='0' align='center' alt='Delete'></a><?php
                            ...
                            if ($st != 'received') {
                                ...
                                echo ' complete ';
                            }echo"</td><td>$o</td><td>$s</td><td>$d</td><td>$sss</td><td align='center'><a href=\"purchase_order.php?mode=show&order_id=" . $o . "\"><img src=\"" . $root_path . "gui/img/common/default/common_infoicon.gif\"  border=\"0\"></a></td></tr>";
                        }
                        ?>
