<?php
$case_arr = $diagnostic_obj->GetCase($id);
            ...
            <tr valign=top>
                <td bgcolor="#99ccff" >
                    ...
                    if ($_SESSION['sess_icd_code_type'] == 10) {
                        echo $case_arr['ICD_10_code'] . ': ' . $case_arr['ICD_10_description'];
                    } else if ($_SESSION['sess_icd_code_type'] == 9) {
                        echo $case_arr['ICD_9_code'] . ': ' . $case_arr['ICD_9_description'];
                    }
                    ?></font></td>
            </tr>
            <tr>
