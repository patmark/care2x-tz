            ...
            <tr valign=top>
                <td bgcolor="#99ccff" >
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr  class="titlebar" >
                            <td>&nbsp;&nbsp;<font color="#330066"><?php
                                if ($_SESSION['sess_icd_code_type'] == 10) {
                                    echo $LDICD10Description;
                                } elseif ($_SESSION['sess_icd_code_type'] == 9) {
                                    echo $LDICD9Description;
                                }
                                ?>
                                (<?php echo $_SESSION['sess_en']; ?>)</font></td>
                            <td align="right"><a href="<?php echo $_SESSION['backpath_diag']; ?>"><img src="../../gui/img/control/default/en/en_back2.gif" border=0 width="110" height="24" alt="" style="filter:alpha(opacity=70)"></a><?php
