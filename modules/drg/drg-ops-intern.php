...
<BODY 
    ...
    onLoad="if (window.focus)
                window.focus();<?php if (isset($saveok) && $saveok) echo 'updateDisplay(\'' . $group_nr . '\');'; ?>" bgcolor="<?php echo $cfg['body_bgcolor']; ?>" 
<?php if (!$cfg['dhtml']) {
