...
if ($bill_no == 10000000000)
    $bill_no = "5" . $ybb . "000000";
...
if ($billid == "currentbill") {
    ...
    for ($i = 0; $i < $itemcnt1; $i++) {
        ...
        if (is_object($resultlbqry1))
            $lb1 = $resultlbqry1->FetchRow();
    ...
    if (is_object($oldbdqueryresult))
        $billitemcount = $oldbdqueryresult->RecordCount();
    ...
    for ($obc = 0; $obc < $billitemcount; $obc++) {
        ...
        if (is_object($itemdescresult))
            $it = $itemdescresult->FetchRow();
...
?>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td width="44%" valign="middle" align="left" height="18"><?php if ($billid == "currentbill") $outstanding;
                            else $outstanding = $oldbilloutstanding;
                            if ($outstanding < 0) echo "0";
                            else echo $outstanding; ?>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td width="56%" valign="middle" align="left" height="19"><b><?php echo $AmountDue ?></b></td>
                                    <td width="44%" valign="middle" align="left" height="19"><b><?php if ($billid == "currentbill") echo $totaldue;
                            else echo $oldbilltotal + $oldbilloutstanding; ?></b>&nbsp;</td>
                                </tr>
                            </table>
