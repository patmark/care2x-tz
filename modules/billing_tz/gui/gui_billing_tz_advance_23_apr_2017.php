...
<BODY bgcolor="#ffffff" link="#000066" alink="#cc0000" vlink="#000066" onLoad="setBallon('BallonTip', '', '')" >
    ...
    <script language="javascript">
        ...
        if(bank.value==""){
            alert("Enter Bank reference id");
            bank.focus();
            return false;
            }
            else
            if (final_bill.value == 1) {
                alert("YOU CANNOT ENTER DEPOSIT BECAUSE THIS ADMISSION NUMBER ALREADY SETTLED FINAL BILL, DISCHARGE THIS PATIENT AND TRY AGAIN.");
                advance.focus();
                return false;
                        ...
                        <tr>
                            <td>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td bgcolor="#ffffdd" width="80" colspan="4">
                                            ...
                                            <input type="hidden" value="<?php echo $_REQUEST['bank_ref']?>" id="bank_ref" name="bank_ref">
                                        </td>
                                ...
                                <table width="600" border="0" align="center">
                                    ...
                                    <?php
if($_REQUEST['bank_ref']==1){
    if($_REQUEST['ins_id']==13  || $_REQUEST['ins_id']<0 ){
