...
//                    }
            ...
            function search_relative(id) {
                ...
                urlholder = "<?php echo $root_path; ?>modules/arv_2/arv_search_family.php?ctc_id=" + ctc_id + "&pid=" + pid;
    ...
    <body>
        ...
        <div class="content">
            ...
            <form id="family_info_existing" name="family_info_existing" method="post" action="">
                <fieldset>
                    <legend onClick="toggle(this)"><img src="<?php echo $root_path; ?>gui/img/common/default/plus_menu.gif" width="18" height="18"><strong>Register Patient Relative From Existing Patient in this Facility</strong></legend>
                    <table width="750" border="0">
                        <tr>
                            <td colspan='7' bgcolor="#F0F8FF"><strong><i>Enter Relative Information From Existing Patient in This Facility</i></strong></td>
                        </tr>
                        <tr>
                            <td width="300" bgcolor="#F0F8FF"><strong>Relation: </strong></td>
                            <td width="534" bgcolor="#F0F8FF"><?php echo $messages['care_tz_arv_relatives_code_id'] . "\n" ?>
                                <?php
                            ...
                            <td width="300" bgcolor="#F0F8FF"><strong>Unique CTC ID Number: </strong></td>
                            <td width="534" bgcolor="#F0F8FF"><?php echo $messages['relative_ctc_id'] . "\n" ?>
                            ...
                            <td bgcolor="#F0F8FF"><a href="javascript:search_relative('family_info');"><img src="../../gui/img/control/blue_aqua/en/en_searchlamp.gif" border=0 width="76" height="21" alt="" style="filter:alpha(opacity=70)" onMouseover="hilite(this, 1)" onMouseOut="hilite(this, 0)"></a></td>
                            <td bgcolor="#F0F8FF">&nbsp;OR&nbsp;</td>
                            <td bgcolor="#F0F8FF"><a href="<?php echo $root_path ?>modules/arv_2/arv_family_info_new.php<?php echo URL_APPEND ?>&encounter_nr=<?php echo $_GET['encounter_nr']; ?>&pid=<?php echo $_GET['pid'] ?>&mode=new" target="_parent"><img src="../../gui/img/control/blue_aqua/en/en_new.gif" border=0 width="76" height="21" alt="" style="filter:alpha(opacity=70)" onMouseover="hilite(this, 1)" onMouseOut="hilite(this, 0)"></a></td>
                        </tr>
                    </table>
                    <table id="family_info" width="750" border="0">
