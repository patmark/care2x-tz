...
<table cellspacing="0"  class="titlebar" border=0>
 <tr valign=top  class="titlebar" >
  <td bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066">Patient CTC Data Overview</font>
    </td>

  <td bgcolor="#99ccff" align=right><a
   href="javascript:gethelp('arv_overview.php','CTC :: Overview')"><img src="../../gui/img/control/blue_aqua/en/en_hilfe-r.gif" border=0 width="76" height="21" alt="" style="filter:alpha(opacity=70)" onMouseover="hilite(this,1)" onMouseOut="hilite(this,0)"></a><a
...
<h1>Follow-up education, Support and Preparation for CTC Therapy</h1>
<table width="588" class="mainTable" >
  ...
  <tr>
    <th><div align="center"><strong>CTC preparation, initiation, support, monitor </strong></div></th>
	<?php
	for($i=0; $i<$max_comments; $i++) {
		echo "<th>&nbsp;</th>";
	}
  ...
  <tr>
    <td><strong>CTC support group</strong></td>
	<?php
	for($i=0; $i<$max_comments; $i++) {
		echo "<td>".$comments[$count][$i]."&nbsp;</td>";
	}
