				...
				<table cellspacing="0"  class="titlebar" border=0>
 					<tr valign=top  class="titlebar" >
  						...
  						<td bgcolor="#99ccff" align=right><a
  							 href="javascript:gethelp('arv_menu.php','CTC Menu','<?php echo $mode; ?>')"><img src="../../gui/img/control/blue_aqua/en/en_hilfe-r.gif" border=0 width="76" height="21" alt="" style="filter:alpha(opacity=70)" onMouseover="hilite(this,1)" onMouseOut="hilite(this,0)"></a><a
							...
							<TABLE cellSpacing=1 cellPadding=3 width=600>
				    			<TBODY class="submenu">
				      				...
				      				<TR> 
				        				...
				        				<TD class="submenu_item"><nobr><a href="arv_preparation.php<?php echo URL_APPEND ?>&encounter_nr=<?php echo $_GET['encounter_nr']; ?>&pid=<?php echo $_GET['pid']?>" target="_parent">CTC preparation, initiation, support monitor </a></nobr></TD>
			        				</tr>
				      				<TR> 
