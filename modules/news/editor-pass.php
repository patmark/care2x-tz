...
if (!isset($_SESSION['sess_file_editor']) || empty($_SESSION['sess_file_editor']))
    $fileforward = $default_forward . URL_REDIRECT_APPEND;
else
    $fileforward = $_SESSION['sess_file_editor'] . URL_REDIRECT_APPEND;

if (!isset($_SESSION['sess_file_break']) || empty($_SESSION['sess_file_break']))
    $breakfile = $default_breakfile . URL_APPEND;
else
...
elseif (!$_SESSION['sess_dept_nr'])
    $_SESSION['sess_dept_nr'] = 1;# Headline news
