...
if (!$linecount) {
    ...
    switch ($mode) {
        case 'list': header("location:pflege-station-patientdaten.php" . URL_REDIRECT_APPEND . "&station=$station&pn=$encounter_nr&nodoc=labor");
            break;
        ...
        <tr bgcolor="#DDE1EC" >
            ...
            <td valign=top><p><br>
                <ul>
                    ...
                    <?php
                    if ($linecount > 1)
                        echo "<p>$LDReportFoundMany";
                    else
                        echo "<p>$LDReportFound";
                    echo " <font color=red><b>$encounter_nr</b></font>.";
                    if ($linecount > 1)
                        echo "<br> $LDIfWantEditMany<p>";
                    else
                        echo "<br> $LDIfWantEdit<p>";
