...
if ($target == 'admin') {
    if (isset($subtarget)) {
        ...
        } else if ($subtarget == 'blood') {
            $allowedarea = $allow_area['lab_bl_r'];
        } else if ($subtarget == 'radio') {
...
if ($target == 'chemlabor') {
    if (isset($case) && $case == 'request') {
        $allowedarea = $allow_area['lab_request'];
    } else {
        $allowedarea = $allow_area['lab_w'];
    }
} else if ($target == 'blood') {
    if (isset($case) && $case == 'request') {
        $allowedarea = $allow_area['lab_bl_w'];
    } else {
        $allowedarea = $allow_area['lab_bl_r'];
    }
