                                            ...
                                            <TR bgColor=#eeeeee>
                                                <TD vAlign=top width=180><FONT 
                                                        face="Verdana,Helvetica,Arial" size=2><B><nobr>
                                                            ...
                                                            <a href="op-doku-pass.php?sid=<?php echo "$sid&lang=$lang" ?>" onmouseover="ssm('ALog');
                                                                    clearTimeout(timer)" 
    ...
    <TBODY>
                ...
                <TABLE cellSpacing=1 cellPadding=3 width=600 bgColor=#999999 
                    ...
                    <TBODY>
                        <TR bgColor=#eeeeee>
                            <TD vAlign=top width=180><FONT 
                                    face="Verdana,Helvetica,Arial" size=2><B><nobr>
                                        <img <?php echo createComIcon($root_path, 'blaupfeil.gif', '0', 'middle') ?>>  <a href="ucons.php" onmouseover="ssm('AnaLog');
                                                clearTimeout(timer)" 
        ...
        <TR bgColor=#eeeeee>
            <TD vAlign=top width=180><FONT 
                    face="Verdana,Helvetica,Arial" size=2><B>
                    <img <?php echo createComIcon($root_path, 'blaupfeil.gif', '0', 'middle') ?>>  
                    <a href="op-pflege-dienstplan.php?sid=<?php echo "$sid&lang=$lang" ?>&dept=anaesth&retpath=menu" onmouseover="ssm('AnaDienstplan');
                            clearTimeout(timer)" 
