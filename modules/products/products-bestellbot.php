            ...
            while ($content = $ergebnis->FetchRow()) {
                ...
                if ($content['status'] == 'ack_print') {
                    if ($content['priority'] == 'urgent')
                        echo '<img ' . createComIcon($root_path, 'check-r.gif', '0') . ' alt="' . $LDUrgent . '">';
                    else
                        echo '<img ' . createComIcon($root_path, 'check2.gif', '0') . ' alt="' . $LDOK . '">';
                }
                else {
                    if ($content['priority'] == 'urgent')
