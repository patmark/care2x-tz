...
<?php
if (file_exists($root_path . 'language/$lang/lang_' . $lang . '_phone.php'))
    include($root_path . "/language/$lang/lang_" . $lang . "_phone.php");
else
    include($root_path . "language/en/lang_en_phone.php");
?>     
