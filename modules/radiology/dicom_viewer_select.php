                        ...
                        <tr>
                            <td>
                                &nbsp;<p>
                                    ...
                                    <input type="radio" name="viewer" value="dcmtk" <?php if ($_SESSION['sess_dicom_viewer'] == 'dcmtk') echo 'checked' ?>> <?php echo 'DICOM Toolkit' ?>
                                    <font size=1> ><a href="http://dicom.offis.de/dcmtk.php.en" target="_blank"><?php echo $LDPlsReadThis ?></a><</font> <br>
                                    <br>
