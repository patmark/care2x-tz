                    ...
                    <td  valign="top" align="middle" height="35">
                        <table cellspacing="0"  class="titlebar" border=0>
                            <tr valign=top  class="titlebar" >
                                <td bgcolor="#99ccff" >
                                    &nbsp;&nbsp;<font color="#330066">Mark out of stock</font>
                                </td>
                            ...
                            <table border=0 cellspacing=1 cellpadding=5>
                                <?php
                                        switch ($_REQUEST['markos']) {
                                            case '1':
                                                $message='Automatic out of stock enabled successifully';
                                                break;
                                            
                                            default:
                                                $message='Manual out of stock enabled successifully';
                                                break;
                                        }
                                ...
                                <tr>
                                    <td class="adm_item" align="right"><FONT  color="#0000cc"><b><?php echo 'Mark Out of Stock'; ?></b></FONT></td>
                                    <td  align="left">
                                        ...
                                        <select name="markos">
                                            ...
                                            if ($GLOBAL_CONFIG['auto_out_of_stock'] == 1) {
                                                echo '<option value="1" selected>Auto</option>';
                                                echo '<option value="0">Manual</option>';
                                            } else {
                                                echo '<option value="1">Auto</option>';
