                ...
                <table border=0 cellspacing=1 cellpadding=2>
                    ...
                    <tr>
                        <td bgcolor="#ffffff">
                            ...
                            &nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path, 'redpfeil.gif', '0', 'absmiddle') ?>><FONT  color="#0000cc" FACE="verdana,arial" size=2>
                            <a href="edv_icdcode_type.php?sid=<?php echo $sid . "&lang=" . $lang ?>" target="SYSADMIN_WFRAME"><?php echo $LDSelectICD; ?>
                            </a></FONT><br>
                            <!-- old code --
...
<!--                    <tr>
                        <td bgcolor="#e9e9e9"><FONT  color="#0000cc" FACE="verdana,arial" size=2><b><?php // echo $LDSelectICD;    ?></b> </FONT></td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff"><FONT  color="#0000cc" FACE="verdana,arial" size=2>&nbsp;&nbsp;&nbsp;<img <?php //echo createComIcon($root_path, 'redpfeil.gif', '0', 'absmiddle')    ?>>
                            <a href="edv_icdcode_type.php?sid=<?php //echo $sid . "&lang=" . $lang    ?>" target="SYSADMIN_WFRAME"><?php //echo $LDSelectICD;    ?>
