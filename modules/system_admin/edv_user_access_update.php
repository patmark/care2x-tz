...
// get date and time 
                    ...
                    if ($dblink_ok) {
                        ...
                        if ($mode == 'save') {
                            ...
                            if (($bereich1 == "")and ( $bereich2 == "")and ( $bereich3 == "")and ( $bereich4 == "")and ( $bereich5 == "")and ( $bereich6 == "")and ( $bereich7 == "")) {
                                $error = 1;
                                $errorbereich = 1;
                            };
				...
				<td colspan=3><FONT    SIZE=-1  FACE=Arial>";
							...
							WHERE name="' . $username . '"';
                                ...
                                if ($db->Execute($sql)) {
                                    ...
                                    if ($bereich1 != "")
                                        echo "$LDArea  1: " . $bereich1 . "<br>";
                                    if ($bereich2 != "")
                                        echo "$LDArea  2: " . $bereich2 . "<br>";
                                    if ($bereich3 != "")
                                        echo "$LDArea  3: " . $bereich3 . "<br>";
                                    if ($bereich4 != "")
                                        echo "$LDArea  4: " . $bereich4 . "<br>";
                                    if ($bereich5 != "")
                                        echo "$LDArea  5: " . $bereich5 . "<br>";
                                    if ($bereich6 != "")
                                        echo "$LDArea  6: " . $bereich6 . "<br>";
                                    if ($bereich7 != "")
                                        echo "$LDArea  7: " . $bereich7 . "<br>";
                                    if ($bereich8 != "")
                                        echo "$LDArea  8: " . $bereich8 . "<br>";
                                    if ($bereich9 != "")
                                        echo "$LDArea  9: " . $bereich9 . "<br>";
                                    if ($bereich10 != "")
                                        echo "$LDArea  10: " . $bereich10 . "<br>";
                                }
                                else {
