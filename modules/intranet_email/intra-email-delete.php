...
if (!isset($maxrow) || (isset($maxrow) && empty($maxrow)) || !isset($folder) || (isset($folder) && empty($folder))) {
    header("location:intra-email.php" . URL_REDIRECT_APPEN . "&mode=listmail");
    exit;
}
if (isset($create) && $create) {
    ...
    if (!isset($delok) || !$delok) {
        header("location:intra-email.php" . URL_REDIRECT_APPEND . "&mode=listmail");
        exit;
    }
}
                ...
                if ($ergebnis = $db->Execute($sql)) {
                    if ($ergebnis->RecordCount()) {
                        ...
                        for ($n = 0; $n < $maxrow; $n++) {
                            ...
                            //echo $delbuf2."<br>";
                            if ($result['trash'] == "")
                                $result['trash'] = $delbuf2 . "\r\n";
                            else
                                $result['trash'].="_" . $delbuf2 . "\r\n";
                        }
