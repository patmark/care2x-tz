...
<?php
if ($saveok)
    echo "var saveTag=true;";
else
    echo "var saveTag=false;";
?>
...
<BODY topmargin=0 leftmargin=0 marginwidth=0 marginheight=0 onLoad="if (window.focus)
            window.focus()" 
<?php if (!$cfg['dhtml']) {
