...
<tr>
                ...
                <td align=right width=32>&nbsp;</td>
                <td align=right width=145><?php echo $LDNHIFItemCode; ?></td>
                <td><input type="text" name="nhif_item_code" value="<?php echo $nhif_item_code;?>" <?php echo $html_disabler;?> size=40 maxlength=40>
                  <?php echo $LDForNHIFCode; ?></td>
              </tr>
              <tr>
                <td align=right>&nbsp;</td>
