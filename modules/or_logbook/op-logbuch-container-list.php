...
';
    ...
    <td class="' . $f_class . '">&nbsp;';
            if ($f_class == "v12")
                echo '<a href="javascript:popinfo(\'' . $parsedstr[a] . '\')"><img ' . createComIcon($root_path, 'info3.gif', '0') . ' alt="' . $LDDbInfo . '"></a>';
            else
                echo '<a href="#"><img  ' . createComIcon($root_path, 'info3-pale.gif', '0') . '  alt="' . $LDArticleNoList . '"></a>';
            echo '
	&nbsp;</td>
