...
/* if(!$_SESSION['sess_opfclic_rt']) $_SESSION['sess_opfclic_rt'];
  if(!$_SESSION['sess_opfclic_filename']) $_SESSION['sess_opfclic_filename'];
 */
...
if ($resetmainput)
    echo 'refreshparent();';
if ($scrolltab)
    echo 'scroll2input(\'' . $scrolltab . '\');setTimeout(\'scroll2time()\',30000);';
else
    echo 'scroll2time();';
