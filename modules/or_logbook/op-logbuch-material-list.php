...
';
        for ($i = 0; $i < $rows; $i++) {
    		...
    		<td class="' . $f_class . '">&nbsp;';
            if ($f_class == "v12")
                echo '<a href="javascript:popinfo(' . $parsedstr[b] . ')"><img ' . createComIcon($root_path, 'info3.gif', '0') . ' alt="' . $LDDbInfo . '"></a>';
            else
                echo '<a href="#"><img ' . createComIcon($root_path, 'info3-pale.gif', '0') . ' alt="' . $LDArticleNoList . '" title="' . $LDArticleNoList . '"></a>';
            echo '
			&nbsp;</td>
