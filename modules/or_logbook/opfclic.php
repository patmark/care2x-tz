            ...
            for ($i = 0; $i < $esize; $i++) {
                ...
                if ($g == "wait_time") {
                    ...
                    if ($elem[s] != "") {
                        //if($vf>$sf)
                        {
                            if (($elem[e] == "") || (($vf < $ef) && ($vf > $sf))) {
                                $ebuf[$i] = "s=" . $elem[s] . "&e=" . $v . "&r=" . $elem[r];
                                $append = 0;
                                break;
                            }
                        }
