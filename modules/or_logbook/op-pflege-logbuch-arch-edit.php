    ...
    while (!sizeof($titles)) {
        ...
        if ($xday > 1) {
            ...
            if (checkdate($xmon, '31', $xyr))
                $xday = 31;
            else if (checkdate($xmon, '30', $xyr))
                $xday = 30;
            else if (checkdate($xmon, '29', $xyr))
                $xday = 29;
            else
                $xday = 28;
        } else
...
<BODY background="../img/gray2.jpg" topmargin=0 leftmargin=0 marginwidth=0 marginheight=0 onLoad="if (window.focus)
            window.focus();
<?php
if ($mode == 'save')
...
<td align=right bgcolor="navy">
    ...
    &nbsp; 
    Hilfe &nbsp; 
    <a href="#" onClick="window.parent.opener.focus();
            window.parent.close();"><FONT  COLOR="white"  SIZE=3 face=verdana,arial >Schliessen</a>
</td>
</TR>
</TABLE>
