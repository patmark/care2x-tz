<?php
if ($rt != "optimeinput") {
    header("location: invalid-access-warning.php");
    exit;
};
...
<BODY  background=img/gray2.jpg TEXT="#000000" LINK="#0000FF" VLINK="#800080" topmargin=0 leftmargin=0 marginwidth=0 marginheight=0
       onLoad="if (window.focus)
                   window.focus();<?php if ($mode == 'save') echo 'resettimebars();';
    if ($scope == 3) echo 'window.resizeTo(600,500)';
    else echo 'window.resizeTo(450,500)'; ?>" >
        ...
        <tr>
            <td bgcolor="navy" align=right>
                <font face=arial size=2 >
                        ...
                        if ($scope == 1)
                            echo '<font color=silver>Ein/Aus &nbsp;</font>';
                        else
                            echo '<a href="' . $thisurl . $filename . '&scope=1"><font color=white>Ein/Aus</a> &nbsp;</font>';
                        if ($scope == 2)
                            echo '<font color=silver>Schnitt/Naht &nbsp;</font>';
                        else
                            echo '<a href="' . $thisurl . $filename . '&scope=2"><font color=white>Schnitt/Naht</a> &nbsp;</font>';
                        if ($scope == 3)
                            echo '<font color=silver>Wartezeit &nbsp;</font>';
                        else
                            echo '<a href="' . $thisurl . $filename . '&scope=3"><font color=white>Wartezeit</a> &nbsp;</font>';
                        if ($scope == 4)
                            echo '<font color=silver>Gipsen &nbsp;</font>';
                        else
                            echo '<a href="' . $thisurl . $filename . '&scope=4"><font color=white>Gipsen</a> &nbsp;</font>';
                        if ($scope == 5)
                            echo '<font color=silver>Reposition &nbsp;</font>';
                        else
                            echo '<a href="' . $thisurl . $filename . '&scope=5"><font color=white>Reposition</a> &nbsp;</font>';
                        ?>
            </td>
        </tr>
        <tr>
