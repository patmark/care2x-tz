        ...
        if ($edit) {
            ...
            if ($dept_nr == 47) {
                ...
                if ($o_tb_patient->is_tb_admitted($patient['pid'])) {
                    $temp_image = "<a href=\"javascript:getTB('" . $patient['pid'] . "','" . $patient['encounter_nr'] . "')\"><img " . createComIcon($root_path, 'powdot.gif', '0', '', TRUE) . " alt=\"in TB Care\" title=\"TB Module: Click\"></a>";
                } else {
