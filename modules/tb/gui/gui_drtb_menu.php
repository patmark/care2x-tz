                            ...
                            <TABLE cellSpacing=0  width=600 class="submenu_frame" cellpadding="0">
                                <TBODY>
                                                ...
                                                if ($mode == "registered") {
                                                    ...
                                                    <TBODY class="submenu">
                                                        <TR> 
                                                            ...
                                                            <TD class="submenu_item"><nobr><a href="tb_drtb_registration.php<?php echo URL_APPEND ?>&encounter_nr=<?php echo $_GET['encounter_nr']; ?>&pid=<?php echo $_GET['pid'] ?>&mode=edit" >
                                                            Edit DR - TB Patient</a></nobr></TD>
                                            <TD>Edit Patient's DR - TB Registration Data</TD>
                                        </tr>
                                        <TR> 
                                            <td align=center><img src="../../gui/img/common/default/new_group.gif" border=0></td>
                                            <TD class="submenu_item"><nobr><a href="tb_treatment_episodes.php<?php echo URL_APPEND ?>&encounter_nr=<?php echo $_GET['encounter_nr']; ?>&pid=<?php echo $_GET['pid'] ?>&mode=new" >
                                            Previous TB Treatment Episodes</a></nobr>
                                    </TD>
                                    <TD>Add/Edit Patient's Previous Tuberculosis Treatment Episodes</TD>
                                    </tr>
                                    <!--                                                                        <TR> 
                                    ...
                                    <TR> 
                                        ...
                                        <TD class="submenu_item"><nobr><a href="tb_treatment_review_meetings.php<?php echo URL_APPEND ?>&encounter_nr=<?php echo $_GET['encounter_nr']; ?>&pid=<?php echo $_GET['pid'] ?>&mode=new" >
                                            Treatment Review Panel Meetings</a></nobr>
                                    </TD>
                                    <TD>Add/Edit Patient's Treatment Review Panel Meetings: Dates and Decisions</TD>
                                    </tr>
                                    <TR  height=1> 
