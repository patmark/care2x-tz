                        ...
                        <TABLE cellSpacing=0  width=600 class="submenu_frame" cellpadding="0">
                            <TBODY>
                                ...
                                <TR> 
                                    ...
                                    <TD class="submenu_item"><nobr><a href="tb_household_contact.php<?php echo URL_APPEND ?>&encounter_nr=<?php echo $_GET['encounter_nr']; ?>&pid=<?php echo $_GET['pid'] ?>" >Household Contact</a></nobr></TD>
                                ...
                                <TR> 
                                    ...
                                    <TD class="submenu_item"><nobr><a href="tb_treatment_phases.php<?php echo URL_APPEND ?>&encounter_nr=<?php echo $_GET['encounter_nr']; ?>&pid=<?php echo $_GET['pid'] ?>" >Treatment Phases and Outcomes</a></nobr></TD>
