...
//echo $target_fnc;
if ($target_fnc == "drtbadmitted") {
    $tb_admitted_patients = $tb_obj->getDRTBAdmittedPatients();
    $title = 'DR-TB Registered  - Admitted Patients';
    
} else {
    $tb_admitted_patients = $tb_obj->getTBAdmittedPatients();
    $title = 'TB Registered - Admitted Patients';
//    echo $title;
}
include_once ('gui/gui_tb_admitted.php');
