...
?>
                        ...
                        <tr bgcolor="<?php echo $bgc1 ?>">
                            ...
                            <td>&nbsp;<font face="arial" size=2 color="#000000"><?php if ($stored_request['mainlog_nr']) echo $stored_request['mainlog_nr'];
                                            else echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'; ?></font></td>
                            <td>&nbsp;<font size=1 face="arial"><?php echo $LDLabNumber ?></font></td>
                            <td>&nbsp;<font face="arial" size=2 color="#000000"><?php if ($stored_request['lab_nr']) echo $stored_request['lab_nr'];
                                            else echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'; ?></font></td>
                        </tr>
                        <tr bgcolor="<?php echo $bgc1 ?>">
                            ...
                            <td>&nbsp;<font face="arial" size=2 color="#000000"><?php if ($stored_request['mainlog_date'] != DBF_NODATE) echo formatDate2Local($stored_request['mainlog_date'], $date_format);
                                            else echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'; ?></font></td>
                            <td>&nbsp;<font size=1 face="arial"><?php echo $LDDate ?></font></td>
                            <td>&nbsp;<font face="arial" size=2 color="#000000"><?php if ($stored_request['lab_date'] != DBF_NODATE) echo formatDate2Local($stored_request['lab_date'], $date_format);
                                            else echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'; ?></font></td>
                        </tr>
                        <tr bgcolor="<?php echo $bgc1 ?>">
