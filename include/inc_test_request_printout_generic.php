<?php /* $abtname=get_meta_tags($root_path."global_conf/$lang/konsil_tag_dept.pid");
...
<table   cellpadding=0 cellspacing=0 border="0" width=700>
    <tr  valign="top">
        <td bgcolor="<?php echo $bgc1 ?>"  class=fva2_ml10><div   class=fva2_ml10>
                ...
                <p>
                <?php printCheckBox('visit');
                echo '&nbsp;' . $LDVisitRequested; ?><p>
                <?php printCheckBox('order_patient');
                echo '&nbsp;' . $LDPatCanBeOrdered; ?><p>
                    <?php
