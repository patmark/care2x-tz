...
//echo $arr_facility['main_info_facility_name'];
            ...
            <table border=0 bgcolor="#ffffff" cellpadding=0 cellspacing=0>
                        ...
                        <table   cellpadding=0 cellspacing=1 border=0 width=700>
                            <tr  valign="top">
                                ...
                                <td bgcolor="<?php echo $bgc1 ?>"  class=fva2_ml10><div   class=fva2_ml10><font size=5 color="#0000ff"><b><?php echo $formtitle ?></b></font>
                                        <br><?php echo $global_address[$subtarget] . '<br>' . $arr_facility['main_info_facility_name'] . '&nbsp;' . '<br>'.$arr_facility['main_info_address'].'<br>'.$arr_facility['main_info_email']; ?>
                                        </td>
                                        </tr>
                                        <tr>
                ...
                <tr bgcolor="<?php echo $bgc1 ?>">
                    <td colspan=2><div class=fva2_ml10><?php echo $LDClinicalInfo ?>:<p><blockquote><img src="<?php echo $root_path ?>gui/img/common/default/pixel.gif" border=0 width=1 height=45 align="left">
                                ...
                                echo nl2br(stripslashes($stored_request['clinical_info'])); 
                                //echo $enc_notes;
                                ?></font></blockquote>
                    </td>
                </tr>
