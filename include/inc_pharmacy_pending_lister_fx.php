...
while ($test_request = $requests->FetchRow()) {
	...
	onmouseout=\"hideBallon(); return true;\" href=\"" . $thisfile . URL_APPEND . "&refreshed=".'TRUE'."&target=" . $target . "&subtarget=" . $subtarget . "&prescription_date=" . $test_request['prescribe_date'] . "&pn=" . $test_request['encounter_nr'] .
