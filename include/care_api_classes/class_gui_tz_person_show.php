                    ...
                    <td bgcolor="#ffffee">
                        ...
                        <b><?php echo formatDate2Local($date_reg, $date_format); ?>
                            ...
                            <tr>
                                ...
                                <?php
                                $vTemp = '<input name="encounter_type" type="radio" value="1" checked';
                                if ($encounter_type == "1") {
                                ...
                                $vTemp .= $LDReferralCase . ''
                                        . '</br>'
                                        . '<b>' . $LDReferralNo . ':</b>&nbsp;&nbsp;<input type="text" style="width:93px" name="referralNo"><br>';


                                if (($insurance_ID == 12 || $insurance_name == 'NHIF') && $glob_obj->getConfigValue("validate_nhif") === "1") {

                                    echo '<td rowspan=7><div style="min-width:300px" id="output_nhif"><b>' . $LDVisitType . ':</b> ';

                                    echo $vTemp;
                                    echo "<input id=\"authorize_btn\" type=\"button\" style=\"margin-top:10px; margin-left:auto; margin-right:auto;\" value=\"Authorize NHIF Card\" "
                                    . "onClick = \"verify_card('$membership_nr')\"/></div></td>";
                                } else { //Visit types for non insured by NHIF
                                    echo '<td rowspan=7><div style="min-width:300px" id="output_nhif"><b>' . $LDVisitType . ':</b> ';

                                    echo $vTemp;
                                    echo "<input id=\"authorize_btn\" type=\"button\" style=\"margin-top:10px; margin-left:auto; margin-right:auto;\" value=\"Send Visit Type Data\" "
                                    . "onClick = \"verify_visit()\"/></div></td>";
                                }
                                ?>
                            </tr>
                            <tr>
