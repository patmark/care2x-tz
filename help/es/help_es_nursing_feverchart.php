...
<a name="howto">
    ...
    <form action="#" >
        <p><font size=2 face="verdana,arial" > 
            <?php if ($src == "main") : ?>
                <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b> 
                    &iquest;Como...?</b></font> 
            <ul type="disc">
                <li><a href="#cbp">Ingresar la temperatura o presi�n arterial.</a> 
                <li><a href="#movedate">Mover o cambiar la fecha en la gr�fica</a> 
                <li><a href="#diet">Indicar una dieta.</a> 
                <li><a href="#allergy">Ingresar informaci�n de alergias.</a> 
                <li><a href="#diag">Ingresar el Diagn�stico principal o terapia.</a> 
                <li><a href="#daydiag">Ingresar informes diarios de diagnostico o indicaciones 
                        de tratamiento.</a> 
                <li><a href="#extra">Escribir notas, diagn�sticos extra, etc.</a> 
                <li><a href="#pt">Escribir indicaciones diarias de terapia fisica, ejercicios 
                        antitrombosis, etc.</a> 
                <li><a href="#coag">Preescribir anticoagulantes.</a> 
                <li><a href="#daycoag">Informar de la aplicaci�n diaria de anticoagulantes.</a> 
                <li><a href="#lot">Escribir notas en implantes, Numeros de lote, num de cargo, 
                        etc.</a> 
                <li><a href="#med">Indicar medicamentos y dosis.</a> 
                <li><a href="#daymed">Informar de la aplicaci�n diaria de medicamentos y dosis.</a> 
            ...
            <p><font size=2 face="verdana,arial" ><font color="990000"><strong><font face="Verdana, Arial, Helvetica, sans-serif">�Como 
                    ingresar la temperatura o presi�n arterial?</font></strong></font></font> 
            <ul>
                ...
                <ul type="disc">
                    <li><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Escriba 
                        la hora y presi�n arterial en la columna izquierda "<font color="#cc0000">Presi&oacute;n 
                        Arterial </font>".<br>
                        Ejemplo: 
                ...
                <ul >
                    ...
                    Hora. Aparecer� automaticamente la hora exacta actual en ese campo.</font> 
                </ul>
                ...
                <b>Paso 4: </b>Si desea corregir algun error, haga clic en el dato err�neo, 
                reempl�celo con el correcto y s�lvelo de nuevo.<br>
                <b>Paso 5: </b>Si ha terminado, d� clic al bot�n <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> 
                para cerrar la ventana y volver a la gr�fica.</font>
            </ul>
            ...
            <p><a name="movedate"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>></a><font color="990000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>�Como 
                    cambiar la fecha de la gr�fica?</strong></font> </p>
            <ul>
                <li><font color="#660000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Para 
                    ...
                    <b>Paso 1: </b>Haga clic en el �cono <img <?php echo createComIcon('../', 'l_arrowgrnsm.gif', '0') ?>>a 
                    la <span style="background-color:yellow" >izquierda</span> de la columna 
                    de fecha de la gr�fica. </font> 
                    <p> 
                <li><font color="#660000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Para 
                        moverse al d�a siguiente:</b></font><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>
                    <b>Paso 1: </b>Haga clic en el �cono <img <?php echo createComIcon('../', 'bul_arrowgrnsm.gif', '0') ?>> 
                    a la <span style="background-color:yellow" >derecha</span> de la columna 
                    de fecha de la gr�fica. </font> 
                    <p> 
                <li><font color="#660000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Para 
                        ir directamente a la fecha de inicio de la gr�fica:</b></font><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>
                    <b>Paso 1: </b>D� clic al <span style="background-color:yellow" >bot�n derecho 
                        del rat�n</span> en el &iacute;cono<img <?php echo createComIcon('../', 'l_arrowgrnsm.gif', '0') ?>> 
                    a la <span style="background-color:yellow" >izquierda</span> de la columna 
                    de fecha de la gr�fica.<br>
                    <b>Paso 2: </b>Haga clic en 
                    <input type="button" value="OK">
                    cuando le pida su confirmaci&oacute;n.<br>
                    <b>Paso 3: </b>Una peque�a ventana aparecer� mostrando los campos para la 
                    fecha de inicio<br>
                    <b>Paso 4: </b>Seleccione d�a, mes y a�o.<br>
                    <b>Paso 5: </b>D� clic en el bot�n 
                    <input type="button" value="Ir">
                    para hacer el cambio.<br>
                    Se cerrar� la ventanita y la gr�fica ajustar� el cambio de fecha. </font> 
                    <p> 
                <li><font color="#660000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Para 
                        ir directamente a la &uacute;ltima fecha de la gr�fica:</b></font><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>
                    <b>Paso 1: </b>D� clic al <span style="background-color:yellow" >bot�n derecho 
                        del rat�n</span> en el &iacute;cono<img <?php echo createComIcon('../', 'l_arrowgrnsm.gif', '0') ?>> 
                    a la <span style="background-color:yellow" >derecha</span> de la columna 
                    de fecha de la gr�fica.<br>
                    ...
                    para hacer el cambio.<br>
                    Se cerrar� la ventanita y la gr�fica ajustar� el cambio de fecha<br>
            ...
            <ul>
                ...
                "<span style="background-color:yellow" > Incorpore la nueva informaci�n o 
                    edite Aqu� </span>".<br>
                <b>Paso 2: </b>D� clic en el bot�n <img <?php echo createLDImgSrc('../', 'savedisc.gif', '0') ?>> 
                para salvar la informaci&oacute;n<br>
                <b>Nota: </b>Si desea cancelar, d� clic al bot�n<img <?php echo createLDImgSrc('../', 'cancel.gif', '0') ?> align="absmiddle">.<br>
                <b>Paso 3: </b>Si quiere corregir errores, haga clic en el dato err�neo, reempl�celo 
                con el correcto y s�lvelo de nuevo.<br>
                <b>Paso 4:</b> Si ha terminado, d� clic al bot�n <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> 
                para cerrar la ventana y volver a la gr�fica.</font>
            </ul>
            ...
            <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a name="allergy"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>> 
                    ...
                    ingresar informaci�n de Alergias?</strong></font></font></p>
            <ul>
                ...
                <b>Paso 2: </b>Una ventana aparecer� mostrando los campos de la informaci&oacute;n 
                de alergia.<br>
                <b>Paso 3: </b>Escriba la Alergia en el campo<br>
                "<span style="background-color:yellow" > Incorpore la nueva informaci&oacute;n 
                    aqu&iacute;: </span>"<br>
                <b>Nota: </b>Puede editar tambi�n la informaci�n en el campo "<span style="background-color:yellow" > 
                    Entradas actuales: </span>" de ser necesario.<br>
                <b>Nota: </b>Si desea cancelar, d� clic al bot�n<img <?php echo createLDImgSrc('../', 'cancel.gif', '0') ?> align="absmiddle">.<br>
                <b>Paso 4: </b>D� clic en el bot�n <img <?php echo createLDImgSrc('../', 'savedisc.gif', '0') ?>> 
                para salvar la informaci&oacute;n.<br>
                <b>Paso 5: </b>Si desea corregir algun error, haga clic en el dato err�neo, 
                reempl�celo con el correcto y s�lvelo de nuevo..<br>
                <b>Paso 6: </b>Si ha terminado, d� clic al bot�n <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> 
                para cerrar la ventana y volver a la gr�fica.<br>
                </font><font color="#000099" size=1><a href="#howto"><img <?php echo createComIcon('../', 'arrow-t.gif', '0') ?>> 
                    Volver al inicio...?"</a></font> 
            </ul>
            ...
            <ul>
                ...
                <b>Paso 3: </b>Escriba la informaci�n del diagnostico o terapia en el campo<br>
                "<span style="background-color:yellow" > Incorpore la nueva informaci&oacute;n 
                    aqu&iacute;: </span>".<br>
                <b>Nota: </b>Puede editar tambi�n la informaci�n en el campo "<span style="background-color:yellow" > 
                    Entradas actuales: </span>" de ser necesario.<br>
            ...
            <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a name="daydiag"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>> 
                ...
                ingresar la informaci�n diaria de diagnosticos o plan de terapia? </strong></font></font> 
            <ul>
                <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>D� 
                ...
                reempl�celo con el correcto y s�lvelo de nuevo.<br>
                <b>Paso 6: </b>Si ha terminado, d� clic al bot�n <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> 
                para cerrar la ventana y volver a la gr�fica. </font> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>
                </font><font color="#000099" size=1><a href="#howto"><img <?php echo createComIcon('../', 'arrow-t.gif', '0') ?>> 
                    Volver al inicio...?"</a></font> 
            </ul>
            ...
            <ul>
                ...
                </b>D� clic al &iacute;cono <img <?php echo createComIcon('../', 'clip.gif', '0') ?>> 
            ...
            <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a name="pt"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>> 
                ...
                ingresar la informaci�n </strong></font><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><font color="990000"><strong>diaria</strong></font></font><font color="990000"><strong> 
            ...
            <ul>
                ...
                <b>Paso 3: </b>Escriba la informaci�n en el campo<br>
                "<span style="background-color:yellow" > Incorpore la nueva informaci&oacute;n 
                    aqu&iacute;: </span>".<br>
                <b>Nota: </b>Puede editar tambi�n la informaci�n en el campo "<span style="background-color:yellow" > 
                    Entradas actuales: </span>" de ser necesario.<br>
            ...
            <ul>
                ...
                <b>Paso 3: </b>Escriba la informaci�n del anticoagulante y dosis en el campo<br>
                "<span style="background-color:yellow" > Incorpore la nueva informaci&oacute;n 
                    aqu&iacute;: </span>".<br>
                <b>Nota: </b>Puede editar tambi�n la informaci�n en el campo "<span style="background-color:yellow" > 
                    Entradas actuales: </span>" de ser necesario.<br>
            ...
            <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a name="daycoag"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>> 
                ...
                ingresar la informaci�n de la aplicaci�n de anticoagulantes diarios?</strong></font></font> 
            <ul>
                <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>D� 
            ...
            <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a name="lot"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>> 
                ...
                ingresar notas en implantes, N�mero de lote,N�mero de cargo, etc?</strong></font></font> 
            <ul>
                <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>D� 
                clic al &iacute;cono <img <?php echo createComIcon('../', 'clip.gif', '0') ?>> 
            ...
            <ul>
                ...
                <b>Paso 4: </b>Seleccione el c�digo de color del medicamento de ser necesario.<br>
                </font> 
                <ul type=disc>
                ...
                editar tambi�n la informaci�n de ser necesario.<br>
                <b>Paso 5: </b>Escriba su nombre en el campo "<span style="background-color:yellow" > 
                    Enfermera: </span>" .<br>
                <b>Nota: </b>Si desea cancelar, d� clic al bot�n<img <?php echo createLDImgSrc('../', 'cancel.gif', '0') ?> align="absmiddle">.<br>
                <b>Paso 6: </b>D� clic en el bot�n <img <?php echo createLDImgSrc('../', 'savedisc.gif', '0') ?>> 
                para salvar la informaci&oacute;n.<br>
                <b>Paso 7:</b> Si desea corregir algun error, haga clic en el dato err�neo, 
                reempl�celo con el correcto y s�lvelo de nuevo.<br>
                <b>Paso 8: </b>Si ha terminado, d� clic al bot�n <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> 
                para cerrar la ventana y volver a la gr�fica.</font><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>
                </font><font color="#000099" size=1><a href="#howto"><img <?php echo createComIcon('../', 'arrow-t.gif', '0') ?>> 
                    Volver al inicio...?"</a></font> 
            </ul>
            ...
            <ul>
                <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>CD� 
                ...
                <b>Paso 3: </b>Escriba la dosis, informaci�n del aplicador, o simbolos de 
        ...
        <?php elseif (($src == "") && ($x1 == "template")) : ?>
            ...
            <font color="#990000"><b> No quiero ver la �ltima lista de ocupaci�n. �C�mo 
            ...
            <ul>
                ...
                <ul type="disc">
                    ...
                    <li><font size="2" face="Verdana, Arial, Helvetica, sans-serif">por su Apellido, 
                        ...
                        <input type="text" name="t" size=19 maxlength=10 value="S�nchez">
                        ". </font> 
        ...
        <?php elseif (($src == "getlast") && ($x1 == "last")) : ?>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b> 
                �C�mo copiar la �ltima lista grabada a la lista de ocupaci�n de hoy?</b></font></font> 
            <ul>
                <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>D&eacute; 
                clic en el bot&oacute;n 
        ...
        <?php elseif ($src == "assign") : ?>
            ...
            <ul>
                ...
                <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: 
                    </b>D� clic a la caja si no est&aacute; marcada.</font> 
                <p> 
            </ul>
            <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Nota: </b>Si 
            desea cancelar, d� clic al bot�n<img <?php echo createLDImgSrc('../', 'cancel.gif', '0') ?> align="absmiddle">.</ul> 
        <?php endif; ?>
        </font> 
    </form>
