    ...
    <form action="#" >
        <p><font size=2 face="verdana,arial" > 
            ...
            <blockquote>
                <p><font size=2 face="Verdana, Arial, Helvetica, sans-serif"><b>Tip:</b> Para 
                    ...
                    Aparecer� automaticamente la hora exacta actual en ese campo.</font> </p>
            </blockquote>
            <ul>
        ...
        <?php if ($src == "allergy") : ?>
            <a name="allergy"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>></a><font color="990000"><strong>�Como 
                ingresar informaci�n de Alergias?</b></strong></font></font> <strong></strong> </font> 
            <ul>
                <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Escriba 
        ...
        <?php if ($src == "diag_ther") : ?>
            ...
            <ul>
                <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Escriba 
                la informaci�n del diagnostico o terapia en el campo<br>
                "<span style="background-color:yellow" > Incorpore la nueva informaci&oacute;n 
                    aqu&iacute;: </span>".<br>
                <b>Nota: </b>Puede editar tambi�n la informaci�n en el campo "<span style="background-color:yellow" > 
                    Entradas actuales: </span>" de ser necesario.<br>
        ...
        <?php if ($src == "anticoag") : ?>
            ...
            <ul>
                <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>escriba 
                la informaci�n del anticoagulante y dosis en el campo<br>
                "<span style="background-color:yellow" > Incorpore la nueva informaci&oacute;n 
                    aqu&iacute;: </span>".<br>
                <b>Nota: </b>Puede editar tambi�n la informaci�n en el campo "<span style="background-color:yellow" > 
                    Entradas actuales: </span>" de ser necesario.<br>
        ...
        <?php if ($src == "medication_dailydose") : ?>
            ...
            <?php else : ?>
                ...
                <ul>
                    ...
                    para cerrar la ventana y volver a la gr�fica.</font><br>
                </ul>
            <?php endif; ?>
        <?php endif; ?>
