...
<form action="#" >
    ...
    <?php if ($src == "") : ?>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b> 
            &iquest;C�mo seleccionar el color del fondo?</b> </font></font> 
        <ul>
            ...
            <b>Paso 3: </b>D� clic al color que desee como fondo.<br>
        ...
        <ul>
            ...
            <b>Paso 2: </b>Aparecera una ventana con una paleta de colores.<br>
            <b>Paso 3: </b>D� clic al color que desee para el texto.<br>
            <b>Paso 4: </b>D� clic al bot&oacute;n 
        ...
        <ul>
            <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 5: </b>D� clic 
            al bot&oacute;n 
    ...
    <?php if ($src == "ext") : ?>
        ...
        <ul>
            ...
            <b>Paso 2: </b>Aparecera una ventana con una paleta de colores.<br>
            <b>Paso 3: </b>D� clic al color que desee para el enlace activo.<br>
            <b>Paso 4: </b>D� clic al bot&oacute;n 
        ...
        <ul>
            ...
            el marco que desee cambiar.<br>
            <b>Paso 2: </b>Aparecera una ventana con una paleta de colores.<br>
            <b>Paso 3: </b>D� clic al color que desee para el enlace hover link.<br>
            <b>Paso 4: </b>D� clic al bot&oacute;n 
