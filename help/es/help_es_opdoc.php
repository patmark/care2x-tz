...
<b>
    Documentaci�n - Quirofano
    <?php
    if ($src == "create") {
        switch ($x1) {
            case "dummy": print "Crear un nuevo documento";
                break;
            case "saveok": print " - El documento est� salvado";
                break;
    ...
    if ($src == "search") {
        switch ($x1) {
            ...
            case "": print "Buscar un documento";
                break;
            case "match": print "Lista de resultados de b�squeda";
                break;
...
<form action="#" >
    ...
    <?php if ($src == "create") : ?>
        <?php if ($x1 == "saveok") : ?>
            ...
            <font color="#990000"><b> &iquest;C�mo empezar un nuevo documento?</b> </font></font> 
            <ul>
                <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>D� 
                clic al bot&oacute;n 
    ...
    <?php if ($x1 == "update") : ?>
            ...
            <ul>
                <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><b>Paso 
                            1: </b></b>D� clic al bot&oacute;n "<span style="background-color:yellow" > 
                    </span> 
                    ...
                    <b>Paso 3: </b>Para salvar el documento, d� clic al bot�n<img <?php echo createLDImgSrc('../', 'savedisc.gif', '0') ?>> 
                    .<br>
                    </font></p>
            </ul>
            ...
            <ul>
                ...
                <ul>
                    ...
                    <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Nota: 
                        </b>Si la b&uacute;squeda encuentra varios resultados aparecer� un listado. 
                ...
                <b>Paso 4: </b>Para salvar el documento, d� clic al bot�n<img <?php echo createLDImgSrc('../', 'savedisc.gif', '0') ?>> 
                .<br>
                </font> 
            </ul>
            <font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
...
<?php if ($src == "search") : ?>
    <?php if (($x1 == "dummy") || ($x1 == "")) : ?>
            ...
            <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../', 'warn.gif', '0', 'absmiddle') ?>> 
                <font color="#990000"><b> Nota:</b></font>Si usted decide cerrar d� clic al 
                bot�n<img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>>.</font></p>
...
<?php if ($src == "arch") : ?>
    <?php if (($x1 == "dummy") || ($x1 == "?") || ($x1 == "")) : ?>
            ...
            <ul>
                ...
                <b>Paso 3: </b>D� clic en el bot�n <img <?php echo createLDImgSrc('../', 'searchlamp.gif', '0') ?>> 
