...
<form action="#" >
    ...
    <?php if ($x1 == "") : ?>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b> 
                <font size="2" face="Verdana, Arial, Helvetica, sans-serif">�C�mo se crea un nuevo derecho 
    ...
    <?php if ($x1 == "save") : ?>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b> 
                El nuevo acceso est� salvado ahora. �Como creo otro acceso?</b> </font></font> 
            <ul>
                <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>D� clic 
                al bot&oacute;n 
