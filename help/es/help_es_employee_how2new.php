<font face="Verdana, Arial" size=3 color="#0000cc"><b>Administraci�n de personal</b></font><p>
    <?php
    if (!$src && !$x1) {
        ?>
    ...
    <form action="#" >
        ...
        <ul>
            ...
            <p><font size="2"> Escriba ya sea la informaci�n completa o las primeras letras 
        ...
        <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 7:</b></font><font size="2" face="Verdana, Arial, Helvetica, sans-serif">D� 
        ...
        <ul>
            ...
            la informaci&oacute;n en los campos marcados con rojo. Despu&eacute;s, d� 
    ...
    if ($src) {
        ...
        <ul>
            ...
            <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 2:</b> 
                D� clic al bot&oacute;n <img <?php echo createLDImgSrc('../', 'savedisc.gif', '0') ?>> 
