    ...
    <?php if ($src == "pass") : ?>
        <?php if ($x1 == "") : ?>
            ...
            <ul>
                ...
                <b>Paso 4: </b>D� clic al bot&oacute;n 
                <input name="button" type="button" value="Accesar">
                para lograrlo.<br>
                </font> 
            </ul>
            <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>> 
            <font color="#990000"><b> A�n no tengo email. �como lo obtengo?</b> </font></font> 
            <ul>
                ...
                <b>Paso 2: </b>Para instrucciones adicionales, d� clic en el bot�n "Ayuda" 
    ...
    <?php if ($x1 == "1") : ?>
            ...
            <ul>
                ...
                <b>Paso 2: </b>Escriba el nombre de email que desee en el campo"<span style="background-color:yellow" > 
                    Escoja una direcci�n de email: </span>". </font> 
                ...
                <b>Paso 4: </b>Escriba el alias de su elecci�n en el campo "<span style="background-color:yellow" > 
                    Alias: </span>"<b>.</b> </font>
                <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 5: 
                    </b>Escriba la contrase&ntilde;a de su elecci�n en el campo"<span style="background-color:yellow" > 
                    ...
                    <b>Paso 3: </b>D� clic al bot&oacute;n 
...
<?php if ($src == "mail") : ?>
    ...
    <?php if ($x1 == "compose") : ?>
            ...
            <ul>
                ...
                su direcci�n) escriba su direcci&oacute;n en el campo "<span style="background-color:yellow" >(BCC) 
                </span>".<br>
            ...
            <ul>
                ...
                <b>Paso 2: </b>Despu�s de escribir su mensaje, d� clic en el bot�n 
            ...
            <ul>
                ...
                abajo de "Direccion R�pida"".<br>
                <b>Paso 2: </b>Aparecer� una ventana mostrando tu libreta de direcciones.<br>
                <b>Paso 3: </b>Seleccione la opci�n correspondiente al campo donde ser� copiada 
                </font> 
                <p> 
                <ul>
                ...
                <b>Nota:</b> si quiere reajustar la selecci�n de clic al icono<img src="../img/redpfeil.gif" border=0>.<br>
                ...
                <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 4: 
                    ...
                    <b>Paso 5: </b>D� clic al bot&oacute;n"<span style="background-color:yellow" > 
                        <img src="../img/l_arrowGrnSm.gif" border=0> Cerrar </span>" para cerrar 
                    la ventana.<br>
                    </font>
            </ul>
            <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>> 
            <font color="#990000"><b> �Para que sirve direcci�n r�pida?</b> </font></font> 
            <ul>
                <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Nota: </b>Si 
                usted tiene direcciones guardadas en el cache "Direcci�n r�pida", las primeras 
                5 ser�n listadas. </font> 
                <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: 
                    ...
                    o "CC" o "BCC").<br>
                    <b>Paso 2: </b>D� clic en la direcci�n deseada de la lista "Direcci�n r�pida". 
                    Esta direcci�n ser� copiada en el campo donde hizo clic previamente.<br>
                    </font>
            </ul>
            <font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
    <?php endif; ?>
...
<?php if ($src == "read") : ?>
        ...
        <ul>
            ...
            <b>Paso 2: </b>Aparecer� una versi�n formateada para imprimir.<br>
            <b>Paso 3: </b>D� clic a la opci�n "<span style="background-color:yellow" > 
                < Imprimir > </span>" para imprimirlo.<br>
            <b>Paso 4: </b>Aparecer� el menu de impresoras de Windows. D� clic en el bot�n 
            "OK".<br>
            <b>Paso 5: </b>Para cerrar la ventana de impresi�n, de clic en la opci�n "<span style="background-color:yellow" > 
                < Cerrar > </span>".<br>
            </font> 
        </ul>
        <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>> 
        ...
        <ul>
            ...
            .<br>
            <b>Paso 2: </b>Se le preguntar� si realmente desea borrar el email.<br>
            <b>Paso 3: </b>D� clic al bot&oacute;n 
...
<?php if ($src == "address") : ?>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b> 
            �Como agregar una direcci�n de correo a la Libreta de direcciones?</b> </font></font> 
        <ul>
            <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>D� 
            clic al bot�n 
            <input type="button" value="Agregar nueva direcci�n">
            .<br>
            <b>Paso 2: </b>aparecer� una forma, Escriba el nombre en el campo "<span style="background-color:yellow" > 
                Nombre: </span>".<br>
        ...
        <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>> 
        <font color="#990000"><b> �Como borrar una direcci�n de la libreta de direcciones?</b> 
        </font></font> 
        <ul>
            ...
            <input type="button" value="Borrar">
            .<br>
            <b>Paso 3: </b>Te preguntar� si realmente quiere borrar el email.<br>
            <b>Paso 4: </b>D� clic al bot�n 
            <input type="button" value="OK">
            para eliminar finalmente la direcci�n.</font> 
            <p> 
        </ul>
        <font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
<?php endif; ?>
