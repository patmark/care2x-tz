...
<form action="#" >
    <p><img <?php echo createComIcon('../', 'frage.gif', '0') ?>> 
        <font color="#990000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b> 
            �C�mo mostrar un reporte diagn�stico?</b></font> 
    <ul>
        ...
        <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso: </b>D� 
            clic en un n�mero particular de reporte en el �ndice izquierdo para mostrar 
            ese reporte.<br>
            </font>
    </ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>> 
    <font color="#990000"><b> �C�mo imprimir el reporte?</b></font></font> 
    <ul>
        <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso: </b>D� 
        clic al bot�n <img <?php echo createLDImgSrc('../', 'printout.gif', '0') ?> align="absmiddle"> 
