...
<ul>
    <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        ...
        if ($x2 == 'show' || $src == 'sickness') {
            ...
            <font color="#990000"><b>�Como salvar la confirmaci�n?</b></font></font> 
            <ul>
            ...
            ?>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>A�n 
            ...
            <ul>
                ...
                reportes diagn�sticos o reportes solo pueden ser ingresados via el laboratorio 
            ...
            ?>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>><font color="#990000"><b><font color="#990000"><b>A�n 
    ...
    <ul>
        ...
        la informaci�n y luego haga clic en el bot�n<img <?php echo createLDImgSrc('../', 'savedisc.gif', '0') ?>> 
        . </font> 
    </ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>> 
    ...
    <ul>
        ...
        D� clic al icono <img <?php echo createComIcon('../', 'show-calendar.gif', '0') ?>> 
        y aparecer� un mini-calendario. </font> 
        <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img src="../help/es/img/es_date_select.png"> 
            </font>
        <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 2: </b> 
            D� clic a la fecha en el mini-calendario. </font>
