...
<?php if ($src == "search") : ?>
    <?php if (($x2 != "") && ($x2 != "0")) : ?>
        ...
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Como selecionar um paciente em particular cujo relat�rio do laborat�rio quero <?php if ($x1 == "edit") print "editar";
        else print "veja"; ?>?</b>
        </font>
        <ul>       	
            <b>Passo 1: </b>Clique no bot�o&nbsp;<button><img <?php echo createComIcon('../', 'update2.gif', '0') ?>> <font size=1>Lab report</font></button> correspondente a um paciente em particular cujo relat�rio do laborat�rio quero  <?php if ($x1 == "edit") print "editar";
        else print "ver"; ?>.<p> 
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
    ...
    <?php if (($x2 == "") || ($x2 == "0")) : ?>
            <b>Passo 3: </b>Clique no bot�o&nbsp;<button><img <?php echo createComIcon('../', 'update2.gif', '0') ?>> <font size=1>Lab report</font></button> correspondente a um paciente em particular cujo relat�rio do laborat�rio quero  <?php if ($x1 == "edit") print "editar";
        else print "ver"; ?>.<p> 
    <?php endif; ?>
    </ul>
