...
switch ($x1) {
    case "entry": print $foreword . 'a new patient\'s admission';
        break;
    case "search": print $foreword . 'search for a patient\'s admission data';
        break;
    case "archiv": print $foreword . 'researching in the archives';
        break;
}
?>
...
<?php else : ?>
    ...
    <p>
        ...
        <?php if ($src != $x1) : ?>
            <b>Step 1</b>
        <ul> Click the <img src="../gui/img/control/default/en/en<?php
            switch ($x1) {
    ...
    <ul> If you have logged in before and you have an access right for this function, the 
        <?php
        switch ($x1) {
            case "entry": print 'patient\'s	admission form';
                break;
            case "search": print 'search field ';
                break;
            case "archiv": print 'archive\'s search field';
                break;
        }
