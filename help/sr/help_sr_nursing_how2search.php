...
<b>
    ...
    switch ($x2) {
        case "search": print "How to ";
            if ($x1)
                print 'display the ward\'s occupancy where the search keyword was found';
            else
...
<form action="#" >
    ...
    <?php if (!$x1) : ?>
        ...
        <b>Step <?php if ($x1) print "1";
    else print "5"; ?></b><ul>Click the button <img <?php echo createComIcon('../', 'bul_arrowblusm.gif', '0') ?>>,
