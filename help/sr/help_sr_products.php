...
<?php if ($src == "how2") : ?>
    ...
    else print "products from medical depot"; ?>?
        </b>
        </font>
        <ul>       	
        ...
        <ul>       	
            <b>Step 1: </b>You can proceed to sending the order list to the  <?php if ($x2 == "pharma") print "pharmacy";
    else print "medical depot"; ?>. <br>Click the button <input type="button" value="Finalize order list"> to start the procedure.<br>
            ...
            <b>Step 6: </b>Click the button <input type="button" value="Send this order list to the <?php if ($x2 == "pharma") print "pharmacy";
    else print "medical depot"; ?>"> to send the order list.<br>
        </ul>
        ...
        <ul>     
            <b>Step 1: </b>Click the link "<span style="background-color:yellow" > <img <?php echo createComIcon('../', 'arrow-blu.gif', '0') ?>> End ordering </span>" to go back to the <?php if ($x2 == "pharma") print "pharmacy";
    else print "medical depot"; ?>'s submenu.<br>
        </ul>	
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
