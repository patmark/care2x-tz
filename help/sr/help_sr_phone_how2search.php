...
<b>How to 
    <?php
    switch ($x1) {
        case "search": print 'search for a phone number';
            break;
        case "dir": print 'open the entire phone directory';
            break;
        case "newphone": print 'enter new phone information';
            break;
    }
    ?></b></font>
...
<?php if ($x1 == "search") { ?>
    ...
    <?php } ?>
        <b>Step <?php if ($src == "newphone") print "2";
    else print "1"; ?></b>
