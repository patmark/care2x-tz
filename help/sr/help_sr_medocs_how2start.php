...
switch ($x1) {
    case "entry": print $foreword . 'a new medocs document';
        break;
    case "search": print $foreword . 'a search for a medocs document';
        break;
    case "archiv": print $foreword . 'researching in the medocs archives';
        break;
}
?>
...
<?php else : ?>
    ...
    <p>
        ...
        <?php if ($src != $x1) : ?>
            <b>Step 1</b>
        <ul> Click the button <img src="../img/en/en<?php
            switch ($x1) {
    ...
    <ul> If you have logged in before and you have an access right for this function, the 
        <?php
        switch ($x1) {
            case "entry": print 'initial document form';
                break;
