...
<?php if ($src == "search") : ?>
    <?php if (($x2 != "") && ($x2 != "0")) : ?>
        ...
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            How to select a particular patient whose lab report I want to <?php if ($x1 == "edit") print "edit";
        else print "see"; ?>?</b>
        </font>
        <ul>       	
            <b>Step 1: </b>Click the button&nbsp;<button><img <?php echo createComIcon('../', 'update2.gif', '0') ?>> <font size=1>Lab report</font></button> corresponding to the patient whose lab report you want to  <?php if ($x1 == "edit") print "edit";
        else print "see"; ?>.<p> 
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
    ...
    <?php if (($x2 == "") || ($x2 == "0")) : ?>
            <b>Step 3: </b>Click the button&nbsp;<button><img <?php echo createComIcon('../', 'update2.gif', '0') ?>> <font size=1>Lab report</font></button> corresponding to the patient whose lab report you want to  <?php if ($x1 == "edit") print "edit";
        else print "see"; ?>.<p> 
    <?php endif; ?>
    </ul>
