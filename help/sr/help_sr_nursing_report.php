...
<a name="howto">
    ...
    <b><?php if ($x1 == "docs") print "Physician orders";
else print "Nursing report"; ?></b></font>
    <form action="#" >
        <p><font size=2 face="verdana,arial" >

<?php if ($src == "") : ?>
                <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                    How to enter a <?php if ($x1 == "docs") print "physician orders";
    else print "nursing report"; ?>?</b></font>
            <ul> 
                <b>Step 1: </b>Enter the date in the "<span style="background-color:yellow" > Date: <input type="text" name="d" size=10 maxlength=10 value="10.10.2002"> </span>" field in the "<?php if ($x1 == "docs") print "physician orders";
    else print "Nursing report"; ?>" column.<br>
                ...
                <b>Step 2: </b>Enter the time in the "<span style="background-color:yellow" > Time: <input type="text" name="d" size=5 maxlength=5 value="10.35"> </span>" field in the "<?php if ($x1 == "docs") print "physician orders";
    else print "Nursing report"; ?>" column.<br>
                ...
                <b>Step 3: </b>Type the <?php if ($x1 == "docs") print "physician orders";
    else print "nursing report"; ?> in the "<span style="background-color:yellow" > <?php if ($x1 == "docs") print "physician orders";
    else print "Nursing report"; ?>: <input type="text" name="d" size=10 maxlength=10 value="test report"> </span>" field.<br>
                <font color="#000099" size=1><b>Tips:</b>
                <ul type=disc>
                    <li>Click the checkbox "<span style="background-color:yellow" > <input type="checkbox" name="c" value="c"> <img <?php echo createComIcon('../', 'warn.gif', '0') ?>>Place this symbol at the start. </span>", if you want that the symbol <img <?php echo createComIcon('../', 'warn.gif', '0') ?>> appears at the start of the <?php if ($x1 == "docs") print "physician orders";
            ...
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                How to enter <?php if ($x1 == "docs") print "an inquiry to the physician";
    else print "an effectivity report"; ?>?</b></font>
            <ul> 
                <b>Step 1: </b>Enter the date in the "<span style="background-color:yellow" > Date: <input type="text" name="d" size=10 maxlength=10 value="10.10.2002"> </span>" field in the "<?php if ($x1 == "docs") print "Inquiries to the physician";
    else print "Effectivity report"; ?>" column.<br>
                <font color="#000099" size=1><b>Tips:</b>
                <ul type=disc>
                    <li>To enter the current date, type "t" or "T" (meaning TODAY) in the date field. The current date will appear automatically in the date field.
                    <li>Or click on the button <img <?php echo createComIcon('../', 'arrow-t.gif', '0') ?>> below the field. The current date will appear automatically in the date field.
                ...
                <b>Step 2: </b>Type the <?php if ($x1 == "docs") print "inquiry";
    else print "effectivity report"; ?> in the "<span style="background-color:yellow" > <?php if ($x1 == "docs") print "Inquiries to the physician";
    else print "Effectivity report"; ?>: <input type="text" name="d" size=10 maxlength=10 value="test report"> </span>" field.<br>
                <font color="#000099" size=1><b>Tips:</b>
                <ul type=disc>
                    <li>Click the checkbox "<span style="background-color:yellow" > <input type="checkbox" name="c" value="c"> <img <?php echo createComIcon('../', 'warn.gif', '0') ?>>Place this symbol at the start. </span>", if you want that the symbol <img <?php echo createComIcon('../', 'warn.gif', '0') ?>> appears at the start of the <?php if ($x1 == "docs") print "inquiry";
            ...
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                NOTE:</b></font>
            <ul> 
                You can also enter both the <?php if ($x1 == "docs") print "physician orders and inquiries to the physician";
    else print "nursing and effectivity report"; ?> at the same time.</ul>
