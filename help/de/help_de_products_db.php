...
<b>
    ...
    switch ($src) {
        case "input": if ($x1 == "update")
                print "Aktualisieren von Produktinformation";
            else
                print "Eingabe von neuen Produkten in die Datenbank";
            break;
...
<?php if ($src == "input") : ?>
    ...
    <?php if ($x1 == "update") : ?>
            ...
            <ul>       	
                <b>Schritt 1: </b>Falls n�tig l�schen Sie zuerst die alte Information aus dem betroffenen Feld.<p>
                    <b>Schritt 2: </b>Geben Sie die aktuelle Information in das entsprechende Feld ein.<p>
                    <b>Schritt 3: </b>Klickt den <input type="button" value="Speichern"> Knopf an um die aktuelle �nderung zu speichern.<br>
            </ul>
        <?php endif; ?>	
    <?php endif; ?>	
    ...
    <?php if ($x1 == "multiple") : ?>
            ...
            <ul>       	
                ...
                <b>Schritt 3: </b>Wenn Sie sicher sind das Produkt zu l�schen, klickt den<input type="button" value="Ja, ich bin sicher. Daten l�schen."> Knopf an.<p>
                    <img <?php echo createComIcon('../', 'warn.gif', '0', 'absmiddle') ?>> <font color="#990000"><b> Achtung!</b></font> Das Entfernen von Produkten l�sst sich nicht r�ckg�ngig machen.<br>
            </ul>	
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
...
<?php if ($src == "delete") : ?>
        ...
        <ul>       	
            <img <?php echo createComIcon('../', 'warn.gif', '0', 'absmiddle') ?>> <font color="#990000"><b> Achtung!</b></font> Das Entfernen von Produkten l�sst sich nicht r�ckg�ngig machen.<p>
...
<?php if ($src == "report") : ?>
        ...
        Wenn Sie abbrechen bzw. beenden m�chten klickt den <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> Knopf an.
        </ul>
<?php endif; ?>	
</form>
