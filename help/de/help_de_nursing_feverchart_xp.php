    ...
    <form action="#" >
        ...
        <?php if ($src == "diet") : ?>
            ...
            <ul> <b>Schritt 1: </b>Gibt den Kostplan ein.<br>
                ...
                <b>Schritt 4: </b>Wenn Sie fertig sind klickt den <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> Knopf an um das Fenster zu schliessen und in die Kurve zur�ck zu gehen.<br>
            </ul>
        <?php endif; ?>
        <?php if ($src == "allergy") : ?>
        ...
        <?php if ($src == "medication") : ?>
            ...
            <ul> 
                ...
                <b>Schritt 7: </b>Wenn Sie fertig sind klickt den <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> Knopf an um das Fenster zu schliessen und in die Kurve zur�ck zu gehen.<br>
            </ul>
        <?php endif; ?>
        <?php if ($src == "medication_dailydose") : ?>
            ...
            <?php else : ?>
                ...
                <ul> 
                    <b>Schritt 1: </b>Klickt den <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> Knopf an um das Fenster zu schliessen und in die Kurve zur�ck zu gehen.<br>
                    ...
                    <b>Schritt 10: </b>Wenn Sie fertig sind klickt den <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> Knopf an um das Fenster zu schliessen und in die Kurve zur�ck zu gehen.<br>
                </ul>
            <?php endif; ?>
        <?php endif; ?>
