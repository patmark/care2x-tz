    ...
    switch ($src) {
        case "access": switch ($x1) {
                ...
                case "update": print "Zugangsberechtigung bearbeiten";
                    break;
                case "lock": if ($x2 == "0")
                        print "Sperre einer Zugangsberechtigung";
                    else
                        print "Aufhebung einer Sperre";
                    break;
...
<form action="#" >
    ...
    <?php if ($src == "access") : ?>
        <?php if ($x1 == "") : ?>
            ...
            <ul>       	
                ...
                <b>Schritt 2: </b>Geben Sie den Benutzerkennung bzw. Benutzername in das Feld "<span style="background-color:yellow" > Benutzerkennung </span>" ein.<p>
                    <b>Achtung!</b> Leerzeichen is nicht erlaubt f�r Benutzerkennung.<p>
                    <b>Schritt 3: </b>Geben Sie das Passwort in das Feld "<span style="background-color:yellow" > Passwort </span>" ein.<br>
                    <b>Schritt 4: </b>W�hle die Bereiche aus den Auswahlfeldern   "<span style="background-color:yellow" > Bereich # </span>" aus wo der 
        ...
        <?php if ($x1 == "list") : ?>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Was bedeuten die beiden Kn�pfe <img <?php echo createComIcon('../', 'padlock.gif', '0', 'absmiddle') ?>> und <img <?php echo createComIcon('../', 'arrow-gr.gif', '0', 'absmiddle') ?>> ?</b>
            </font>
            <ul>       	
            ...
            <ul>       	
                <b>�: </b> = �ndern oder Bearbeiten.<br>
                <b>S: </b> = Sperren.<br>
                <b>L: </b> = L�schen.<br>
                <b>F: </b> = Freigabe oder Sperre aufheben.<br>
            </ul>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Wie kann ich die Zugangsberechtigung �ndern bzw. bearbeiten?</b>
            </font>
            <ul>       	
                Klickt die Option "<span style="background-color:yellow" > � </span>" an.<br>
            </ul>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            ...
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Wie kann ich die Zugangsberechtigung l�schen?</b>
            </font>
            <ul>       	
        ...
        <?php if ($x1 == "update") : ?>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Wie kann ich eine Zugangsberechtigung �ndern?</b>
            </font>
            <ul>       	
            ...
            <ul>       	
                Wenn Sie nicht bearbeiten m�chten klicken Sie den <input type="button" value="Abbrechen"> Knopf an.<br>
            </ul>

        <?php endif; ?>		
        <?php if ($x1 == "delete") : ?>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Wie l�sche ich eine Zugangsberechtigung?</b>
            </font>
            <ul>       	
                <b>Schritt 1: </b>Wenn Sie sicher sind die Zugangsberechtigung zu l�schen,<br>
                klicken Sie den <input type="button" value="Ja, ich bin sicher. Berechtigung l�schen."> Knopf an.<br>
            </ul>
            <img <?php echo createComIcon('../', 'warn.gif', '0', 'absmiddle') ?>> <font color="#990000"><b>
                Achtung!</b>
            </font>
            <ul>       	
                Wenn Sie nicht l�schen m�chten klicken Sie den <input type="button" value="Nein. Zur�ck."> Knopf an.<br>
            </ul>
        ...
        <?php if ($x1 == "lock") : ?>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Wie kann ich eine  <?php if ($x2 == "0") print "Zugangsberechtigung sperren";
        else print "Sperre aufheben"; ?>?</b>
            </font>
            <ul>       	
                <b>Schritt 1: </b>Wenn Sie sicher sind die <?php if ($x2 == "0") print "Zugangsberechtigung zu sperren";
        else print "Sperre aufzuheben"; ?>,<br>
            ...
            <ul>       	
                Wenn Sie <?php if ($x2 == "0") print "nicht sperren";
        else print "die Sperre nicht aufheben"; ?> m�chten
                klicken Sie den  <input type="button" value="Nein. Zur�ck."> Knopf an.<br>
            </ul>
