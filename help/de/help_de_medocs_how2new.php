...
<form action="#" >
        ...
        <ul> Suchen Sie zuerst den Patient.<br>
            ...
            <Ul type="disc">
                ...
                <li>Vorname vom Patient<br>
                    ...
                    <b>Tipp:</b> Wenn Ihr System �ber einen Strichcode Scanner verf�gt, klicken Sie das Feld "Den folgenden Patient dokumetieren:" an und
                    lesen Sie den Strichcode mit dem Scanner ein. �berspringen Sie den Schritt 2.
                    </font>
            </ul>
    ...
    <?php endif; ?>
    <?php if (($x1 == "1") || ($src == "?")) : ?>
        <ul> Wenn die Patientendaten eingeblendet sind k�nnen Sie folgendes tun: 
            <Ul type="disc">		
                <li>Zusatzangaben �ber die Krankenkasse bzw. Versicherung in das Feld "weitere Angaben:" eingeben,<br>
                <li>den "<span style="background-color:yellow" ><input type="radio" name="n" value="a">Ja</span>" am  "Aufkl�rung" anklicken wenn der Patient eine Aufkl�rung erhalten hat,<br>
                <li>den "<span style="background-color:yellow" ><input type="radio" name="n" value="a">Nein</span>" am  "Aufkl�rung" anklicken wenn der Patient KEINE Aufkl�rung erhalten hat,<br>
                ...
                <li>falls erforderlich, eine Schl�sselnummer in das Feld "Schl�sselnummer:" eingeben.<br>
            </ul>
        </ul>
        <b>Achtung!</b>
        <ul> Falls Sie alle Eingaben l�schen m�chten den <input type="button" value="R�cksetzen"> anklicken.
        </ul>

        <b>Schritt <?php if ($src != "?") print "2";
    else print "5"; ?></b>
