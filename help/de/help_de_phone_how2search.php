...
<b>Wie
    <?php
    switch ($x1) {
        case "search": print 'suche ich nach einer Telefonnummer?';
            break;
        case "dir": print '�ffne ich das Telefonverzeichnis?';
            break;
        case "newphone": print 'trage ich eine neue Telefonnumer ein?';
            break;
    }
    ?></b></font>
...
<?php if ($x1 == "search") { ?>
    ...
    <?php } ?>
        <b>Schritt <?php if ($src == "newphone") print "2";
    else print "1"; ?></b>

        <ul> Geben Sie in das Suchfeld "<span style="background-color:yellow" >Ihr Suchbegriff</span>"
            entweder eine vollst�ndige Information oder die ersten paar Buchstaben/Zeichen ein, wie zum Beispiel
        ...
        <b>Schritt <?php if ($src == "newphone") print "3";
    else print "2"; ?></b>
        <ul> Zum Starten der Suche klicken Sie auf <input type="button" value="SEARCH">.<p>
        </ul>
        <b>Schritt <?php if ($src == "newphone") print "4";
    else print "3"; ?></b>
    ...
    if ($x1 == "newphone") {
        if ($src == "search") {
            ...
            <b>Schritt 2</b>
            <ul> Wenn Sie eingeloggt und f�r diese Funktion zugriffsberechtigt sind, wird Ihnen das Eintragsformular f�r
                neue Telefon-Informationen angezeigt.<br>
                Ansonsten, wenn Sie nicht eingeloggt sind, erscheint eine Eingabeaufforderung f�r Ihren Benutzernamen und
                Ihr Passwort.<p>
    <?php } ?>
    ...
    <ul> Zum Abbrechen
        <?php
        switch ($x1) {
            case "search": print ' der Suche klicken Sie auf <img ' . createLDImgSrc('../', 'cancel.gif', '0') . '>.';
                break;
            case "dir": print ' des Verzeichnisses klicken Sie auf <input type="button" value="Cancel">.';
                break;
            case "newphone": print ' klicken Sie auf <img ' . createLDImgSrc('../', 'cancel.gif', '0') . '>.';
                break;
        }
        ?>
    </ul>
