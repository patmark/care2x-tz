...
<?php if ($src == "search") : ?>
        ...
        <ul>       	
            <b>Schritt 1: </b>Gibt entweder eine vollst�ndige Information oder die erste Zeichen von der Fallnummer vom Patient, von seinem Namen, oder von seinem Vornamen, oder
        ...
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Wie kann ich die Vorschau des R�ntgenbildes und den Befund zeigen lassen?</b>
        </font>
        ...
        <ul>       	
            ...
            Die Vorschau des R�ntgenbildes wird in den unteren linken Rahmen eingeblendet.<br> 
            Der Befund wird in den unteren rechten Rahmen gezeigt.<br> 
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Wie kann ich das R�ntgenbild in voller Gro�e zeigen lassen?</b>
        </font>
        <ul>       	
