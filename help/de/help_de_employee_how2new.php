<font face="Verdana, Arial" size=3 color="#0000cc"><b>Personalverwaltung</b></font><p>
    ...
    <form action="#" >
        ...
        <b>Schritt 3</b>
        <ul>Wenn die Suche ohne Ergebnis ist, m�ssen Sie erst die Person anlegen (registrieren). Klicken Sie auf den
            <img <?php echo createLDImgSrc('../', 'register_gray.gif', '0') ?>>-Button und folgen Sie der Anleitung
            zur Regitstrierung der Person.
        </ul>
        <b>Schritt 4</b>
        <ul>Wenn die Suche erfolgreich ist, w�hlen Sie die richtige Person aus der angezeigten Liste  durch Klick auf
        ...
        <ul>Wenn das Mitarbeiter-Formular angzeigt wird, geben Sie alle relevanten Daten zum Mitarbeiter an.<p>
                ...
                als Mitarbeiter/in besch�ftigt wird, werden ihre Mitarbeiterdaten angezeigt.
        </ul>
        <b>Schritt 6</b>
        <ul>
        ...
        <ul>Fehlen notwendige Angaben, wird Ihnen das Formular erneut zur Bearbeitung vorgelegt mit einem Hinweis, das oder die
            rot markierte/n Feld/er vollst�ndig auszuf�llen. Klicken Sie danach auf den Knopf <img <?php echo createLDImgSrc('../', 'savedisc.gif', '0') ?>>
            zum Abspeichern der eingegebenen Informationen.<p>
        </ul>

        <b>Anmerkung</b>
        <ul>Wenn Sie die Verarbeitung abbrechen m�chten, klicken Sie auf den Button <img <?php echo createLDImgSrc('../', 'cancel.gif', '0') ?>>.
    ...
    if ($src) {
        ?>
        <font color="#990000"><b>Wie �ndere ich die Daten eines Mitarbeiters?</b></font>
        <ul>
            <b>Schritt 1:</b> Geben Sie einfach die neuen Daten in die entsprechenden Felder ein.<p>
                ...
                ge�nderten Informationen zu speichern.<p>
                <img <?php echo createComIcon('../', 'warn.gif', '0') ?>> Anmerkung: Wenn Sie die �nderung abbrechen m�chten,
        ...
        <ul>
            <b>Schritt 1:</b> F�llen Sie einfach die entsprechenden Felder aus.<p>
                <b>Schritt 2:</b> Klicken Sie auf den <img <?php echo createLDImgSrc('../', 'savedisc.gif', '0') ?>>-Button zum Speichern
                der Mitarbeiter-Daten.<p>
                <img <?php echo createComIcon('../', 'warn.gif', '0') ?>> Anmerkung: Wenn Sie die Bearbeitung abbrechen m�chten,
                klicken Sie auf den <img <?php echo createLDImgSrc('../', 'cancel.gif', '0') ?>>-Button.
        </ul>
        <?php
    }
