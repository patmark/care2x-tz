...
<html>
    ...
    <body>
        <font face="Verdana, Arial" size=3 color="#000099"><b>Tips f�r die Personensuche</b></font>
        <p>
    ...
    <font face="Verdana, Arial" size=2>
<blockquote>
    <li>Indem Sie die vollst�ndige Personen-Identifikationsnummer (PID) eingeben.
</blockquote>
<p>
    <img <?php echo createComIcon('../', 'frage.gif', '0') ?>>
    <font color="#990000" face="Verdana, Arial" ><b></a>
...
<p>
    <img <?php echo createComIcon('../', 'frage.gif', '0') ?>>
    <font color="#990000" face="Verdana, Arial" ><b></a>
    Warum sollte ich die Suche auf die Familiennamen beschr�nken?</b></font>
<font face="Verdana, Arial" size=2>
<blockquote>
...
<blockquote>
    <li>Trennen Sie den Vornamen und den Familiennamen durch ein Leerzeichen.<br>
        ...
        <p>
            <img <?php echo createComIcon('../', 'warn.gif', '0') ?>> Anmerkung: Die Reihenfolge der Eintr�ge entscheidet! So
...
<font face="Verdana, Arial" size=2>
<blockquote>
    <li>Geben Sie das komplette Geburtsdatum entsprechend Ihrem g�ltigen Datumsformat ein.
        <br>
...
<p>
    <img <?php echo createComIcon('../', 'frage.gif', '0') ?>>
    <font color="#990000" face="Verdana, Arial" ><b></a>
    Was ist mein g�ltiges Datumsformat?</b></font>
<font face="Verdana, Arial" size=2>
<blockquote>
    <li>Ihr g�ltiges Datumsformat ist <font color="red">
...
<font face="Verdana, Arial" size=2>
<blockquote>
    <li>Geben Sie erst den Vornamen, dann den Familiennamen und schlie�lich das Geburtsjahr ein
        <br>
...
<font face="Verdana, Arial" size=2>
<blockquote>
    <li>Geben Sie einen *, dann ein Leerzeichen, dann wieder *, Leerzeichen und schlie�lich das Jahr ein
        <br>
