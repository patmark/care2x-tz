...
<form action="#" >
    <?php if (($src == "?") || ($x1 == "0")) : ?>
        ...
        <ul>Geben Sie in das Feld "<span style="background-color:yellow" >Medocs Dokument von:</span>" entweder eine vollst�ndige Information oder die erste Zeichen von der Fallnummer, oder dem Namen, oder Vornamen vom Patienten 
            ein.
    ...
    <?php endif; ?>
    <?php if (($src != "?") && ($x1 == "1")) : ?>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>Wie kann ich das Dokument aktualisieren bzw. �ndern?</b></font>
        <ul> Den <input type="button" value="Daten aktualisieren"> anklicken.
        </ul>
    <?php endif; ?><p>
        <b>Achtung!</b>
    <ul> Falls Sie abbrechen m�chten den <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> anklicken.
    </ul>
