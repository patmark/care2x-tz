...
<form action="#" >
    ...
    <?php else : ?>
        ...
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>Alle Dokumente von Patienten mit bestimmten weiteren Angaben �ber die Krankenkasse zeigen</b></font>
        <ul> <b>Schritt 1: </b>Geben Sie die Angaben in das Feld "weitere Angaben:" ein. <br>
            <b>Schritt 2: </b>Lassen Sie die andere Eingabefelder leer.<br>
            <b>Schritt 3: </b>Den <input type="button" value="SUCHEN">  anklicken um die Suche zu starten.<br>
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>Alle Dokumente aller m�nnlichen Patienten zeigen </b></font>
        ...
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>Alle Dokumente aller Patienten mit Aufkl�rung zeigen </b></font>
        <ul> <b>Schritt 1: </b>Den radio button  "Aufkl�rung <input type="radio" name="r" value="1">Ja" anklicken. <br>
            <b>Schritt 2: </b>Lassen Sie die andere Eingabefelder leer.<br>
            <b>Schritt 3: </b>Den <input type="button" value="SUCHEN">  anklicken um die Suche zu starten.<br>
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>Alle Dokumente aller  Patienten OHNE Aufkl�rung zeigen </b></font>
    ...
    <?php endif; ?>
    <b>Achtung!</b>
    <ul> Falls Sie die Recherche abbrechen m�chten, den  <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?> > anklicken.
    </ul>
</form>
