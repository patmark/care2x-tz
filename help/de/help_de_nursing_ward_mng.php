...
<form action="#" >
    ...
    <ul>Um ein Bett bzw. mehrere Betten zu sperren klicken Sie diese Option an. Die angemeldete Station wird gezeigt. Wenn keine Station
        angemeldet ist wird die standard Station gezeigt. Sperren von Betten erfordert ein gultiges Passwort und ein Zugangsrecht f�r diese Funktion.
    </ul>
    <b>Zugangsberechtigungen</b>
    <ul> Mit dieser Option k�nnen Sie Zugangsberechtigungen f�r eine bestimmte Station erstellen, sperren, �ndern, l�schen, oder freigeben. Die erstellte
...
<?php if ($src == "new") : ?>
    ...
    <ul>       	
        <b>Schritt 1: </b>Geben Sie den Namen der Station oder deren Abk�rzung in das Feld "<span style="background-color:yellow" > Station: </span>" ein.<br>
        <b>Schritt 2: </b>Wahlen Sie die Abteilung wo die Station angeh�rt aus dem Feld "<span style="background-color:yellow" > Abteilung: </span>" aus.<br>
    ...
    <ul>       	
        <b>Nein. </b>In dieser Version des Programms, die Bettenmarkierung  ist auf A, B, C, usw. eingestellt. Sie k�nnen sie nicht �ndern.<br>
    </ul>
    <b>Achtung!</b>
    <ul>Falls Sie abbrechen m�chten den <img <?php echo createLDImgSrc('../', 'cancel.gif', '0') ?>> anklicken.
    </ul>
...
<?php if ($src == "show") : ?>
    ...
    <?php else : ?>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            ...
            <b>Achtung!</b> Sie k�nnen ein Stationsprofil nicht nachtr�glich bearbeiten. Wenn Sie eine neue Stationsprofil
            anlegen m�ssen, m�ssen sie die alte Station unwideruflich schliessen. Folgen Sie:
        <ul>
            ...
            verlegt worden).<p>
                ...
                <b>Schritt 3: </b>Legen Sie eine neue Station an. W�hlen Sie die Option "Neue Station anlegen" am Stationsverwaltungsmodul.<p>
        </ul>
        <b>Achtung!</b>
        <ul>  Falls Sie abbrechen m�chten den <img <?php echo createLDImgSrc('../', 'cancel.gif', '0') ?>> anklicken.
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Wozu schliesst man eine Station vor�bergehend?</b>
        </font><p>

        <ul>
            <b>Antwort: </b>Eine Station wird vor�bergehend geschlossen wenn keine Patienten aufgenommen werden kann aus bestimmten Gr�nden wie
...
<?php if ($src == "") : ?>
    ...
    <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
        Wie w�hle ich eine Station zum Anzeigen aus?</b>
    </font>
    <ul>       	
        <b>Schritt 1: </b>Klicken Sie die Station in der Liste an dessen Profil Sie anzeigen m�chten.<br>
    </ul>
    <b>Achtung!</b>
