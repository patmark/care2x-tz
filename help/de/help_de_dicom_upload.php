...
<form action="#" >
    ...
    if (!$src) {
        ...
        <ul>
            <b>Schritt 1: </b>Wenn die zu den Bildern geh�rende Patienten-Aufnahmenummer bekannt ist, geben Sie sie im Feld
            "<font color=#0000ff>Zugeh�rige Aufnahmenummer</font>" ein.<p>
                ...
                um das Datei-Auswahlfenster zu �ffnen.<p>
                <b>Schritt 5: </b>W�hlen Sie die entsprechenden Bilder aus.<p>
                <b>Schritt 6: </b>Wenn Sie alle Bilddateien ausgew�hlt haben, starten Sie durch Klick auf den
            <img <?php echo createLDImgSrc('../', 'savedisc.gif', '0') ?>>-Button den Datei-Upload.<p>
        </ul>

        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Wie �ndere ich die Anzahl der up-zu-loadenden Bilder?</b>
        </font>

        <ul>
            <b>Anmerkung: </b>�ndern Sie die Anzahl der Bilder unbedingt <b>bevor</b> Sie Daten eingeben bzw. bevor Sie
            die Bilddateien ausw�hlen.<p>
        ...
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Wie kann ich nach einem erfolgreichen Upload die Integrit�t der hochgeladenen Bilder �berpr�fen?</b>
        </font>
        <ul>
            <b>Schritt: </b>Klicken Sie auf das Symbol <img <?php echo createComIcon('../', 'torso.gif', '0') ?>>
            der "<b>Bild-Gruppen-Nummer</b>", um die Bilder im aktuellen Frame anzuzeigen (vom Viewer abh�ngig).<p>
        ...
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Wie kann ich nach einem erfolgreichen Upload die Integrit�t jedes einzelnen upgeloadeten Bildes �berpr�fen?</b>
        </font>
        <ul>
            <b>Schritt: </b>Klicken Sie auf das Symbol <img <?php echo createComIcon('../', 'torso.gif', '0') ?>>
