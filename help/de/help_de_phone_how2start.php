...
<b>Wie
    <?php
    switch ($x1) {
        case "search": print 'suche ich nach einer Telefonnumer?';
            break;
        case "dir": print '�ffne ich das Telefonverzeichnis?';
            break;
        case "newphone": print 'trage ich eine neue Telefonnummer ein?';
            break;
    }
    ?></b></font>
    ...
    <ul> Zum Abbrechen
        ...
        switch ($x1) {
            ...
            case "search": print ' der Suche klicken Sie auf <img ' . createLDImgSrc('../', 'cancel.gif', '0') . '>.';
                break;
            case "dir": print ' der Bearbeitung klicken Sie auf <input type="button" value="Cancel">.';
                break;
