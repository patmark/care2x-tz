...
<form action="#" >
    <p><font size=2 face="verdana,arial" >
        ...
        <?php if ($src == "select") : ?>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>Wie kann ich die Daten aktualisieren bzw. �ndern?</b></font>
    ...
    <?php else : ?>
        ...
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>Alle m�nnliche Patienten zeigen </b></font>
        ...
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>Alle station�re Patienten zeigen</b></font>
        <ul> <b>Schritt 1: </b>Den radio button  "<input type="radio" name="r" value="1">Station�r" anklicken. <br>
            <b>Schritt 2: </b>Lassen Sie die andere Eingabefelder leer.<br>
            <b>Schritt 3: </b>Den <input type="button" value="SUCHEN">  anklicken um die Suche zu starten.<br>
        </ul>
        ...
        <ul> <b>Schritt 1: </b>Geben Sie das Suchwort in das Feld ein. Das Suchwort k�nnte ein vollst�ndiges Wort oder dessen erste Buchstaben sein. <br>
            <ul><font size=1 color="#000099" >
                ...
                <b>Beispiel:</b> Um nach �berweiser zu suchen geben Sie das Suchwort in das Feld "Uberwiesen von" ein.<br>
        ...
        <b>Achtung!</b>
        <ul> Sie k�nnen mehrere Suchw�rter bzw. Bedingungen kombinieren. Zum Beispiel: Wenn Sie alle m�nnliche Patienten  suchen die zwischen 10.12.1999 und
            24.01.2001 aufgenommen worden sind:<p>
                ...
                <b>Schritt 3: </b>Den radio button  "Geschlecht <input type="radio" name="r" value="1">m�nnlich" anklicken. <br>
    ...
    <?php endif; ?>
    <b>Achtung!</b>
    <ul> Falls Sie die Recherche abbrechen m�chten, den <input type="button" value="Abbrechen"> anklicken.
    </ul>
</form>
