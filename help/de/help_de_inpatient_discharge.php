...
<ul>
    <b>Schritt 1: </b>�berzeugen Sie sich davon, dass das richtige Entlassungsdatum und die korrekte Uhrzeit
    eingegeben wurden.<br>
    <b>Schritt 2: </b>W�hlen Sie durch Klick auf den entsprechenden Knopf die Art der Entlassung aus.<br>
    <ul><br>
        ...
        <b>Schritt 6: </b>Mit Klick auf den Button <input type="button" value="discharge"> wird die Entlassung ausgel�st.<p>
        <b>Schritt 7: </b>Durch Klick auf <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?> align="absmiddle">
        gelangen Sie wieder zur�ck zum (neuen) Belegungsplan der Station.<p>
</ul>
<img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
    Ich habe versucht, den <input type="button" value="Entlassen">-Knopf anzuklicken, aber es tat sich nichts. Wieso?</b></font>
<ul> <b>Achtung:</b> Die angef�hrte Checkbox muss aktiviert (angekreuzt) sein wie hier zu sehen: <br>
...
<b>Anmerkung: </b>Wenn Sie den Vorgang abbrechen m�chten, ohne die Entlassung auszul�sen, klicken Sie
