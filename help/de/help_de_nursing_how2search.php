...
<b>
    ...
    switch ($x2) {
        case "search":
            if ($x1)
                print 'Belegungsliste einer Station zeigen';
            else
                print 'Suchen nach einem Patienten';
            break;
...
<form action="#" >
    ...
    <?php if (!$x1) : ?>
            ...
            <ul>
                Geben Sie in das Feld "<span style="background-color:yellow" >Bitte ein Stichwort eingeben.</span>" entweder die vollst�ndige Information oder die erste Zeichen wie zum Beispiel Name, oder Vorname, oder beides.
                <ul type=disc>
            ...
            <b>Achtung!</b>
            <ul>  Falls Sie abbrechen m�chten den <img <?php echo createLDImgSrc('../', 'cancel.gif', '0') ?>> anklicken.
            </ul><?php endif; ?>
        <b>Schritt <?php if ($x1) print "1";
    else print "5"; ?></b>
        <ul>Um die Belegungsliste zu sehen, den <img <?php echo createComIcon('../', 'bul_arrowblusm.gif', '0') ?>>,
            ...
            <p><b>Achtung!</b> Das Stichwort wird in der Belegungsliste hervorgehoben.
                <br><b>Achtung!</b> Die Belegungsliste is nur zum sehen. Sie l�sst sich nicht bearbeiten. Wenn Sie trotzdem versuchen die Liste zu bearbeiten werden Sie nach Ihrem 
...
<?php if ($x2 == "quick") : ?>
    <?php if ($x1) : ?>
            ...
            <ul>       	
                ...
                <b>Achtung! </b>Die Belegungsliste wird eingeblendet zum sehen. Die Liste und Daten lassen sich nicht �ndern.<br>
            </ul>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Wie kann ich die Belegungsliste zeigen lassen zum aktualisieren bzw. �ndern?</b>
            </font>
            <ul>       	
                ...
                <b>Schritt 5: </b>Wenn Sie ein Zugangsrecht in dieser Funktion haben wird die Belegungsliste eingeblendet.<p>
                    <b>Achtung! </b>Die Belegungsliste und Daten l�ssen sich bearbeiten d.h. aktualisieren bzw. �ndern. Verschieden Optionen f�r Bearbeitungen werden
                    auch eingeblendet.
                    Sie k�nnen auch die Patientenmappe �ffnen zum sehen bzw. bearbeiten.<br>
            </ul>
    <?php else : ?>
            <img <?php echo createComIcon('../', 'warn.gif', '0', 'absmiddle') ?>> <font color="#990000"><b>
                ...
                <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                    Wie lassen sich die alte Belegungslisten �ber das Archiv zeigen?</b>
                </font>
            <ul>       	
    ...
    <?php endif; ?>
        <b>Achtung!</b>
        <ul> Falls Sie die Schnellsicht schliessen m�chten den <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> anklicken.
        </ul><?php endif; ?>
...
<?php if ($x2 == "arch") : ?>
        ...
        <ul>       	
            <b>Schritt 1: </b>Um den n�chsten Monat zu zeigen klicken Sie den "<span style="background-color:yellow" >Monat ></span>" auf der oberen RECHTEN Ecke des Leitkalenders.
            Klicken Sie so oft wie n�tig bis der gew�nschte Monat angezeigt ist.<p>
                ...
                Klicken Sie so oft wie n�tig bis der gew�nschte Monat angezeigt ist.<br>
        </ul>
