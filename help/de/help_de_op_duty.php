        ...
        <form >
            ...
            <p>
                ...
                <font color="#990000" face="Verdana, Arial">Was kann ich hier sehen?</font></b><p>
                    <font face="Verdana, Arial" size=2>
                    <img <?php echo createComIcon('../', 'update.gif', '0', 'absmiddle') ?>><b> Sie k�nnen zus�tzliche Information (falls vorhanden) �ber die diensthabende Schwester/Pfleger lesen.</b>
                <ul>Um zus�tzliche Information zu sehen , die <span style="background-color:yellow" >Name des Diensthabenden</span> anklicken. Ein kleines Fenster mit der relevanten Information wird sich �ffnen .</ul><p>
                    <img <?php echo createComIcon('../', 'update.gif', '0', 'absmiddle') ?>><b> Sie k�nnen den Dienstplan f�r einen ganzen Monat sehen.</b>
                ...
                <p><b>Was will die Schnellsicht mir sagen?</b></font></b><p>
                    <font face="Verdana, Arial" size=2>
                </b><li><b>OP Abteilung</b> :<ul>Die Liste von Abteilungen die diensthabende Pflegekr�fte haben</ul><p>
                ...
                <li><b>Dienstplan</b> :<ul> Verbindung zum Monatsdienstplan einer Abteilung. Diesen Knopf&nbsp;<button><img <?php echo createComIcon('../', 'new_address.gif', '0', 'absmiddle') ?>> <font size=1>Zeigen</font></button>
                        anklicken wenn Sie den Dienstplan aktualisieren bzw. erstellen oder �ndern m�chten.</ul>


                <?php endif; ?>
                <?php if ($src == "show") : ?>
                    <p>
                        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>Ich m�chte einen neuen Dienstplan f�r diesen Monat erstellen.</b></font>
                    ...
                    <ul><b>Schritt 2:</b>
                        Wenn Sie sich vorher angemeldet haben und ein Zugangsrecht in dieser Funktion haben wird das Eingabeformular eingeblendet.<p>
                            ...
                            Falls Sie abbrechen m�chten den <img <?php echo createLDImgSrc('../', 'cancel.gif', '0') ?>> anklicken.
                    </ul>
                    <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>Ich m�chte einen neuen Dienstplan f�r einen anderen Monat erstellen.</b></font>
                    <ul> <b>Schritt 1: </b>Clicken Sie den "Monat" so oft an bis den gew�nschten Monat angezeigt wird. <br>
                        Klicken Sie den "Monat" auf der rechten Seite an um den n�chsten Monat zu zeigen.<br>
                    ...
                    <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>Ich m�chte die Schnellsicht nochmal sehen.</b></font>
                    <ul> <b>Schritt 1: </b>Den <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?> > anklicken.<br>
                    </ul>
                    <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>Ich m�chte die Funk bzw. Telefonnummer des Diensthabenden sehen. </b></font>
                    <ul> <b>Schritt 1: </b><span style="background-color:yellow" >Klicken Sie den Namen an.</span>  Ein kleines Fenster mit der relevanten Information wird sich �ffnen.<br>
                    </ul>


                    <b>Achtung!</b>
                    <ul> Falls Sie den Dienstplan schliessen m�chten den <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> anklicken.
                    </ul>
                <?php endif; ?>
                <?php if ($src == "plan") : ?>

                    <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                        Ich m�chte eine Schwester bzw. einen Pfleger einplanen anhand der Personalliste. Wie geht das?</b></font>
                    <ul> <b>Schritt 1: </b>Den  &nbsp;<button><img <?php echo createComIcon('../', 'patdata.gif', '0') ?>></button> Knopf des entsprechenden Tages anklicken um die Personalliste zu �ffnen. <br>
                        Ein kleines Fenster mit der Personalliste wird sich �ffnen .<br>
                        <ul type=disc>
                        ...
                        <b>Schritt 2: </b><span style="background-color:yellow" >Den Namen der Schwester/Pfleger</span> in der Personalliste anklicken um ihn in den Dienstplan zu �bertragen.<br>
                    ...
                    <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                        Ich m�chte eine Schwester bzw. einen Pfleger manuell einplanen. Wie geht das?</b></font>
                    ...
                    <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                        Ich m�chte eine Schwester bzw. einen Pfleger aus dem Dienstplan entfernen. Wie geht das?</b></font>
                ...
                <?php if ($src == "personlist") : ?>
                    ...
                    <ul> <b>Schritt 1: </b>W�hlen Sie die richtige Abteilung aus dem Feld <nobr>"<span style="background-color:yellow" >Abteilung wechseln: </span><select name="s">
                    ...
                    <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                        Ich m�chte einen Namen aus der Liste entfernen. Wie geht das?</b></font>
                    <ul> <b>Schritt 1: </b>Das Eingabefeld "<input type="text" name="t" size=11 maxlength=4 value="Name">" des Namens anklicken.<br>
                        <b>Schritt 2: </b>Entfernen Sie manuell den Namen. Benutzen Sie daf�r die Tasten "Entf" oder "R�cktaste" der Tastatur.<br>
                    </ul>
                    <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>Wie kann ich die Liste speichern</b></font>
                    <ul> <b>Schritt 1: </b>Den <img <?php echo createLDImgSrc('../', 'savedisc.gif', '0') ?>> Knopf anklicken.<br>
                    </ul>
                    <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>Ich habe die Liste gespeichert und m�chte jetzt beenden. Was soll ich tun? </b></font>
                    <ul> <b>Schritt 1: </b>Wenn Sie fertig sind den <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> Knopf anklicken. <br>
                    </ul>
                ...
                <?php if ($src == "dutydoc") : ?>
                    ...
                    <ul> <b>Schritt 1: </b>Klickt den <input type="button" value="Drucken"> Knopf an und ein Fenster �ffnet sich.<br>
