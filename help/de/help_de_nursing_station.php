...
<form action="#" >
    <p><font size=2 face="verdana,arial" >
        ...
        <ul> <b>Schritt 1: </b>Den <img <?php echo createComIcon('../', 'plus2.gif', '0') ?>> Knopf der Zimmernummer und Bett anklicken.
            <br>
            <b>Schritt 2: </b>Ein kleines Fenster zum Suchen von Patienten �ffnet sich.<br>
            ...
            <b>Schritt 6: </b>Um den richtigen Patient auszuw�hlen klickt den nebensteheden &nbsp;<button><img <?php echo createComIcon('../', 'post_discussion.gif', '0') ?>></button> Knopf an.<br>
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
        ...
        <ul> <b>Schritt 1: </b>Klickt den <img <?php echo createComIcon('../', 'bestell.gif', '0') ?>> Knopf des Patienten.
            ...
            "<input type="checkbox" name="g" ><span style="background-color:yellow" > Ja, ich bin sicher. Ich m�chte den Patient entlassen.</span>" an um ihn zu aktivieren.<br>
           	<b>Schritt 4: </b>Klickt den <input type="button" value="Entlassen"> Knopf an um den Patient zu entlassen.<p>
                <b>Achtung! </b>Wenn Sie abbrechen m�chten klickt den <img <?php echo createLDImgSrc('../', 'cancel.gif', '0') ?>> Knopf an und der Patient wird nicht entlassen.<br>
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
        ...
        <ul> <b>Schritt 1: </b>Klickt den <img <?php echo createComIcon('../', 'plus2.gif', '0') ?>> Knopf des zu sperrenden Bettes.
            <br>
            <b>Schritt 2: </b>Ein kleines Fenster zum Suchen von Patienten �ffnet sich. Sie wollen aber nicht suchen sonder ein Bett sperren.<br>
            ...
            <b>Schritt 4: </b>Klickt den&nbsp;<button>OK</button> an wenn Sie nach einer Best�tigung gefragt werden.<br>
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Wie kann ich einen Patient aus der Belegungsliste entfernen?</b></font>
        <ul> <b>Achtung! </b>Sie k�nnen einen Patient NICHT einfach aus der Liste entfernen. Um ihn zu entfernen m�ssen Sie ihn entlassen. Um ihn zu entlassen folgen Sie
            die Anweisung (wie oben beschrieben) wie man einen Patient entl�sst.<br>
        </ul>
        ...
        <ul> <b>Achtung! </b>
            Jede Farbe in dieser Farbbalken (wenn gesetzt) signalisiert das Vorhandensein einer Information, Anweisung, �nderung, oder Frage, usw.
            <br>
            Die Bedeutung von jeder Farbe kann f�r jede Station eingestellt werden.
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>>
        <font color="#990000"><b>Was bedeutet dieses Symbol <img <?php echo createComIcon('../', 'patdata.gif', '0') ?>> ? </b></font>
        <ul> <b>Achtung! </b>Dies ist die Patientenmappe. Um die Patientenmappe zu �ffnen klicken Sie dieses Symbol an. 
            Ein kleines Fenster �ffnet sich. Das Fenster zeigt die Basisdaten des Patienten, sein Foto (wenn vorhanden), und andere Optionen.
            <br>
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> 
        <font color="#990000"><b>Was bedeutet dieses Symbol <img <?php echo createComIcon('../', 'bubble2.gif', '0') ?>> ? </b></font>
        <ul> <b>Achtung! </b>Dies ist das Vermerk. Wenn es angeklickt wird �ffnet sich ein kleines Fenster mit einem Eingabefeld f�r Vermerke oder Notizen �ber den Patient.<br>
            Das normal Symbol <img <?php echo createComIcon('../', 'bubble2.gif', '0') ?>> bedeutet da� es noch kein Vermerk beinhaltet. Um ein Vermerk zu schreiben klickt dieses Symbol an.<br>
            Das andere Symbol <img <?php echo createComIcon('../', 'bubble3.gif', '0') ?>> bedeutet da� es Vermerk beinhaltet. Um den Vermerk zu lesen bzw. zu erg�nzen klickt dieses Symbol an.
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>>
    ...
    <?php elseif (($src == "") && ($x1 == "template")) : ?>
        ...
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Was soll ich tun wenn <span style="background-color:yellow" >Die Belegung f�r heute ist noch nicht erstellt</span> angezeigt ist?</b></font>
        <ul> <b>Schritt 1: </b>Klickt den <input type="button" value="Die letzte Belegungsliste zeigen"> Knopf an.
            ...
            <b>Schritt 3: </b>Klickt den <input type="button" value="Diese Belegungsliste auf heute �bernehmen."> Knopf an.<br>
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Ich m�chte die letzte Belegungsliste nicht sehen. Wie erstelle ich eine neue Liste?</b></font>
    ...
    <?php elseif (($src == "getlast") && ($x1 == "last")) : ?>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Wie �bernehme ich die letzte Belegungsliste f�r die heutige Belegung?</b></font>
        <ul> <b>Schritt 1: </b>Klickt den <input type="button" value="Diese Belegungsliste auf heute �bernehmen."> Knopf an um die letzte Belegungsliste zu �bernehmen.
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Die letzte Belegungsliste ist angezeigt aber ich m�chte sie nicht �bernehmen. Wie kann ich eine neue Liste erstellen? </b></font>
        <ul> <b>Schritt 1: </b>Klickt den <input type="button" value="Nicht �bernehmen!  Eine neue Belegungsliste erstellen."> Knopf an um eine neue Liste zu erstellen.
        </ul>
    <?php elseif ($src == "assign") : ?>
        ...
        <ul>
            ...
            <b>Schritt 4: </b>Um den richtigen Patient auszuw�hlen klickt den nebensteheden &nbsp;<button><img <?php echo createComIcon('../', 'post_discussion.gif', '0') ?>></button> Knopf an.<br>
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Wie sperre ich ein Bett??</b></font>
        <ul>
            ...
            <b>Schritt 2: </b>Klickt den&nbsp;<button>OK</button> an wenn Sie nach einer Best�tigung gefragt werden.<br>
        </ul>
        <b>Achtung! </b> Falls Sie abbrechen m�chten den <img <?php echo createLDImgSrc('../', 'cancel.gif', '0') ?>> anklicken.</ul>

    <?php elseif ($src == "remarks") : ?>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Wie schreibe ich Vermerke bzw Notizen �ber den Patient?</b></font>
    ...
    <?php elseif ($src == "discharge") : ?>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Wie kann ich einen Patient entlassen?</b></font>
        <ul> <b>Schritt 1: </b>W�hlen Sie die Art der Entlassung. Klickt die entsprechende Auswahl an.<br>
            <ul><br>
                <input type="radio" name="relart" value="reg" checked> Regul�r entlassen<br>
            ...
            <b>Schritt 2: </b>Tippen Sie (falls erforderlich) weitere Angaben �ber die Entlassung in das Feld "<span style="background-color:yellow" > Vermerk: </span>". <br>
            ...
            <b>Schritt 4: </b>Klickt den " <span style="background-color:yellow" ><input type="checkbox" name="d" value="d"> Ja, ich bin sicher. Ich m�chte den Patient entlassen. </span>" an. <br>
            <b>Schritt 5: </b>Klickt den <input type="button" value="Entlassen"> Knopf um den Patient zu entlassen.<p>
                <b>Schritt 6: </b>Klickt den <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?> align="absmiddle"> Knopf um in die Belegungsliste zur�ck zu gehen.<p>
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
        ...
        <ul> <b>Achtung! </b>Der folgende Checkbox muss angeklickt werden und muss aussehen wie folgendes: <br>
            " <span style="background-color:yellow" ><input type="checkbox" name="d" value="d" checked> Ja, ich bin sicher. Ich m�chte den Patient entlassen. </span>". <p>
    ...
    <?php if (($src != "assign") && ($src != "remarks") && ($src != "discharge")) : ?>
        ...
        <ul> <b>Achtung! </b>Dies bedeutet "Dieses Bett ist gesperrt". Um die Sperre aufzuheben klickt den "<span style="background-color:yellow" ><font color="#0000ff">Gesperrt</font></span>" an und klickt den&nbsp;<button>OK</button>
            wenn Sie nach einer Best�tigung gefragt werden.<p>
                <b>Achtung! </b>Abh�ngig von der Version des Programms, eine Bettsperre aufzuheben k�nnte die Angabe eines Passworts erfordern.</ul>
