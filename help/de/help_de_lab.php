...
<?php if ($src == "search") : ?>
        <?php if (($x2 != "") && ($x2 != "0")) : ?>
            ...
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Wie w�hle ich einen Patient aus dessen Labortestwerte ich <?php if ($x1 == "edit") print "bearbeiten";
        else print "sehen"; ?> m�chte?</b>
            </font>
            <ul>       	
                <b>Schritt 1: </b>Klickt den &nbsp;<button><img <?php echo createComIcon('../', 'update2.gif', '0') ?>> <font size=1>Laborbefund</font></button> Knopf des Patienten den Sie <?php if ($x1 == "edit") print "bearbeiten";
        else print "sehen"; ?> m�chten.<p> 
            </ul>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
        ...
        <ul>       	
            <b>Schritt 1: </b>Gibt entweder eine vollst�ndige Information oder deren ersten Zeichen von dem Namen vom Patient, oder Vorname, oder 
            ...
            <?php if (($x2 == "") || ($x2 == "0")) : ?>
                <b>Schritt 3: </b>Klickt den &nbsp;<button><img <?php echo createComIcon('../', 'update2.gif', '0') ?>> <font size=1>Laborbefund</font></button> Knopf des Patienten den Sie <?php if ($x1 == "edit") print "bearbeiten";
        else print "sehen"; ?> m�chten.<p> 
    <?php endif; ?>
        </ul>
...
<?php endif; ?>
    ...
    <?php if ($x1 == "main") : ?>
            ...
            ?>: </b>Klickt den <img <?php echo createLDImgSrc('../', 'savedisc.gif', '0') ?>> Knopf an um die Werte zu speichern.<p> 
                    <b>Achtung! </b>Wenn Sie die Werte gespeichert haben und die Eingabe beenden m�chten,<br> klickt den <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> Knopf an.<br> 
            </ul>
    <?php endif; ?>
    <?php if ($x1 == "few") : ?>
    ...
    <?php if ($x1 == "param") : ?>
            ...
            <ul>       	
                <b>Schritt 1: </b>W�hle die richtige Parametergruppe aus dem Auswahlfeld <nobr>"<span style="background-color:yellow" > Parametergruppe <select name="s">
    ...
    <?php if ($x1 == "correct") : ?>
            ...
            <ul>       	
                <b>Schritt 1: </b>L�schen Sie einfach den falschen Wert und gibt den richtigen ein.<br> 
                <b>Schritt 2: </b>Klickt den <img <?php echo createLDImgSrc('../', 'savedisc.gif', '0') ?>> Knopf an um die Werte zu speichern.<p> 
                    <b>Achtung! </b>Wenn Sie die Werte gespeichert haben und die Eingabe beenden m�chten,<br> klickt den <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> Knopf an.<br> 
            </ul>
    <?php endif; ?>
