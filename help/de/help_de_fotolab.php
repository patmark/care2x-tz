...
<form action="#" >
    <?php if ($src == "input") : ?>
        ...
        <ul>       	
            ...
            <b>Schritt 2: </b>Ein "Datei ausw�hlen" Fenster �ffnet sich. W�hle die gew�nschte Bilddatei aus und klicke "�ffnen" an.<br>
            ...
            <b>Schritt 4: </b>Gibt das Aufnahmedatum des Fotos in das Feld "<span style="background-color:yellow" > Aufnahmedatum </span>" ein.<p>
                <img src="../img/warn.gif" border=0> <b>Achtung: </b>Dieses Datum k�nnte eventuell mit dem Datum das Sie in die Eingabefelder am Patientendaten eingeben �berschrieben werden. <p>
                Tipp: Wenn Sie m�chten das dieses Datum anders ist als das Aufnahmedatum der meisten Bilder, lassen Sie dieses Feld vorerst mal leer. Sie k�nnen nachtr�glich das Datum eingeben.<p>
            ...
            <font color="#990000">Was mache ich als n�chstes?</font><p>
            ...
            <b>Schritt 10: </b>Klickt den <img src="../img/preset-add.gif" border=0 align="absmiddle"> Knopf an um dieses Datum f�r alle Bilder zu �bernehmen. Dieses
        ...
        <ul>       	
            <b>Nein. </b>Mit dieser Version des Programs k�nnen Sie die Fotos eines Patienten ohne Fallnummer nicht speichern.<br>
        </ul>
<?php endif; ?>	
...
<?php if ($src == "maindata") : ?>
        ...
        <ul>	
            ...
            <b>Schritt 5: </b>Klickt den <img src="../img/preset-add.gif" border=0 align="absmiddle"> Knopf an um dieses Datum f�r alle Bilder zu �bernehmen. Dieses
            Datum wird automatisch in allen "Aufnahmedatum" Felder von den Bildern eingeblendet.<p>
                <img src="../img/warn.gif" border=0><b> Note: </b>Wenn ein oder einige Bildern ein anderes Aufnahmedatum haben soll, gibt dieses Datum in das entsprechende Eingabefeld ein. 
...
<?php if ($src == "save") : ?>
        ...
        <ul>	
            <b>Schritt 1: </b>Gibt die St�ckzahl  in das Feld <nobr>"<span style="background-color:yellow" > Weitere <input type="text" name="g" size=3 maxlength=2> Bilder  von demselben Patient. </span>"</nobr> ein.<br>
        ...
        <ul>	
            <b>Schritt 1: </b>Gibt die St�ckzahl  in das Feld <nobr>"<span style="background-color:yellow" >  <input type="text" name="g" size=3 maxlength=2> Bilder vom anderen Patient. </span>"</nobr> ein.<br>
            <b>Schritt 2: </b>Klickt den <input type="button" value="GO"> Knopf an.<br>
        </ul>
...
<?php if ($src == "init") : ?>
        <?php if ($x1 == "") : ?>
            ...
            <ul>       	
                ...
                <b>Schritt 3: </b>Die Eingabefelder f�r die Fotos werden eingeblendet. Klick die "Hilfe" Knopf um weitere Hilfsanweisung zu lesen.<br>
            </ul>
    <?php endif; ?>	
