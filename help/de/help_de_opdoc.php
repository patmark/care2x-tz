...
<form action="#" >
    <?php if ($src == "create") : ?>
        ...
        <?php if ($x1 == "saveok") : ?>
            ...
            <ul>       	
                <b>Schritt 1: </b>Klickt den <input type="button" value="Aktualisieren bzw. �ndern"> Knopf an um in den Bearbeitungsmodus zu gehen.<br>
            </ul>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
    ...
    <?php if ($x1 == "update") : ?>
            ...
            <ul>       	
                <b>Schritt 1: </b>Wenn das Dokument im Bearbeitungsmodus ist k�nnen Sie die Daten �ndern, erg�nzen, l�schen, oder neu eingeben.<br> 
    ...
    <?php if (($x1 == "dummy") || ($x1 == "") || ($x1 == 'search')) : ?>
            ...
            <ul>       	
                ...
                entweder eine vollst�ndige Information oder die erste Zeichen von dem Namen oder Vornamen vom Patient ein.<br>
                ...
                <ul>       	
                    <b>Achtung! </b>Wenn die Suche ein Ergebnis liefert werden die Grunddaten vom Patient sofort in die entsprechende Felder eingeblendet.<p> 
                        <b>Achtung! </b>Wenn die Suche mehrere Ergebnisse liefert wird eine Liste gezeigt. Clickt den Namen vom Patient an um ihn auszuw�hlen.<p> 
                </ul>
                <b>Schritt 3: </b>Wenn die Grunddaten vom Patient gezeigt ist k�nnen Sie weitere op relevante Information in die entsprechende Eingabefelder
                eingeben.<br> 
...
<?php endif; ?>
    ...
    <?php if ($src == "search") : ?>
        <?php if (($x1 == "dummy") || ($x1 == "")) : ?>
            ...
            <ul>       	
                ...
                <ul>       	
                    <b>Achtung! </b>Wenn die Suche ein Ergebnis liefert werden die Grunddaten vom Patient sofort in die entsprechende Felder eingeblendet.<p> 
                        <b>Achtung! </b>Wenn die Suche mehrere Ergebnisse liefert wird eine Liste gezeigt. Clickt den Namen vom Patient, oder das OP Datum, oder die OP Nummer an um ihn auszuw�hlen.<p> 
                </ul>
            </ul>
            <img <?php echo createComIcon('../', 'warn.gif', '0', 'absmiddle') ?>> <font color="#990000"><b> Achtung!</b></font> 
            <ul>       	
    ...
    <?php if (($x1 == "match") && ($x2 > 0)) : ?>
            ...
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Wie w�hle ich ein bestimmtes Dokument zum lesen aus?</b>
            </font>
            <ul>       	
                <b>Achtung! </b> Clickt den Namen vom Patient, oder das OP Datum, oder die OP Nummer an um ihn auszuw�hlen.<p> 
            </ul>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
...
<?php if ($src == "arch") : ?>
    <?php if (($x1 == "dummy") || ($x1 == "?") || ($x1 == "")) : ?>
            ...
            <ul> <b>Schritt 1: </b>Gibt das Suchwort in das entsprechende Eingabefeld ein. Es kann ein kompletter Satz oder die erste Zeichen sein.<br>
                <ul><font size=1 color="#000099" >
                    <b>Folgende Eingabefelder kann mit einem Suchwort ausgef�llt werden:</b>
                    <br> Fallnummer.
                    <br> Name
                    <br> Vorname
                    <br> Geburtsdatum
            ...
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> 
            <font color="#990000"><b>Wie kann ich alle OP Dokumente von station�ren Patienten auflisten?</b></font>
            <ul> <b>Schritt 1: </b>Klickt den Radiobutton "<span style="background-color:yellow" >Station�r <input type="radio" name="r" value="1"></span>" ein. <br>
                <b>Schritt 2: </b>Lassen Sie die andere Eingabefelder leer.<br>
                <b>Schritt 3: </b>Klickt den <img <?php echo createLDImgSrc('../', 'searchlamp.gif', '0') ?>>  Knopf an um die Suche zu starten.<br>
            </ul>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> 
            ...
            <ul> <b>Schritt 1: </b>Gibt die Klassifikationsnummer in das entsprechende Eingabefeld ein. <br>
                <ul><font size=2 color="#000099" >
                    <b>Beispiel:</b> F�r kleine OP's,  gibt die nummer in das Feld "<span style="background-color:yellow" > <input type="text" name="m" size=4 maxlength=2> klein </span>" ein.<br>
                    <b>Beispiel:</b> F�r mittlere OP's,  gibt die nummer in das Feld  "<span style="background-color:yellow" > <input type="text" name="m" size=4 maxlength=2> mittel </span>" ein.<br>
                    <b>Beispiel:</b> F�r gro�e OP's,  gibt die nummer in das Feld  "<span style="background-color:yellow" > <input type="text" name="m" size=4 maxlength=2> gro�e Eingriff </span>" ein.<br>
                    </font>
                </ul><b>Schritt 2: </b>Lassen Sie die andere Eingabefelder leer.<br>
                <b>Schritt 3: </b>Klickt den <img <?php echo createLDImgSrc('../', 'searchlamp.gif', '0') ?>>  Knopf an um die Suche zu starten.<br>
            </ul>
            <img <?php echo createComIcon('../', 'warn.gif', '0', 'absmiddle') ?>><b><font color="#990000"> Achtung!</font></b>
            <ul> Sie k�nnen mehrere Suchw�rter und Bedingungen kombinieren. Zum Beispiel:
                Wenn Sie alle station�re Patienten auflisten m�chten die von "Dr. Schmidt" operiert wurden und deren
                Therapie mit "lipo" beginnt .<p>
                    ...
                    <b>Schritt 2: </b>Klickt den Radiobutton "<span style="background-color:yellow" > <input type="radio" name="r" value="1" checked>Station�r </span>" an.<br>
                    ...
                    Um das Dokument zu �ffnen klickt den nebenstehenden <img <?php echo createComIcon('../', 'r_arrowgrnsm.gif', '0') ?>> Knopf, oder
    ...
    <?php if (($x1 == "search") && ($x2 > 0)) : ?>
            ...
            <ul>       	
                <b>Schritt 1: </b>Klickt den <input type="button" value="Neue Suche im Archiv"> Knopf an um in die Eingabefelder des Archivs zur�ck zu gehen.<p> 
            </ul>
            <img <?php echo createComIcon('../', 'warn.gif', '0', 'absmiddle') ?>> <font color="#990000"><b> Achtung!</b></font> 
            <ul>       	
                Wenn Sie abbrechen m�chten klickt den <img <?php echo createLDImgSrc('../', 'close2.gif', '0') ?>> Knopf an.
