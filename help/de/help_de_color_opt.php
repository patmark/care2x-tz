...
<form action="#" >
    <?php if ($src == "") : ?>
        ...
        <ul>       	
            <b>Schritt 1: </b>Klickt die Option "<span style="background-color:yellow" > Hintergrundfarbe <img src="../img/settings_tree.gif" border=0> </span>" des gew�hlten Rahmens an.<br>
            <b>Schritt 2: </b>Ein Fenster mit Farbpalette �ffnet sich.<br>
            <b>Schritt 3: </b>Klict die gew�nschte Farbe f�r den Hintergrund an.<br>
            <b>Schritt 4: </b>Klickt den <input type="button" value="�bernehmen"> Knopf an um die Farbe zu �bernehmen.<br>
        ...
        <ul>       	
            ...
            <b>Schritt 2: </b>Ein Fenster mit Farbpalette �ffnet sich.<br>
            <b>Schritt 3: </b>Klict die gew�nschte Farbe f�r den Text an.<br>
            <b>Schritt 4: </b>Klickt den <input type="button" value="�bernehmen"> Knopf an um die Farbe zu �bernehmen.<br>
            <b>Schritt 5: </b>Wenn Sie fertig sind klickt den <input type="button" value="OK"> Knopf an.<br>
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Wie stelle ich die Farben f�r "hover" und "link" ein?</b>
        </font>
        <ul>       	
    ...
    <?php if ($src == "ext") : ?>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Wie stelle ich die Farbe f�r "active link" ein?</b>
        </font>
        <ul>       	
        ...
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Wie stelle ich die Farbe f�r "hover" ein?</b>
        </font>
        <ul>       	
