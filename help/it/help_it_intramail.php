...
<?php endif; ?>	
    <?php if ($src == "mail") : ?>
        <?php if ($x1 == "listmail") : ?>
            ...
            <ul>       	
                <img src="../img/c-mail.gif" border=0 align="absmiddle"> = La mail non � ancora stata aperta.<br>
                <img src="../img/o-mail.gif" border=0 align="absmiddle"> = La mail � gi� stata aperta.<br>
            </ul>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
    ...
    <?php if ($x1 == "compose") : ?>
            ...
            <ul>       	
                ...
                <b>5: </b>Ora si pu� inserire il testo del messaggio.<br>
            ...
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Come fare ad usare un indirizzo che � nella mia rubrica?</b>
            </font>
            <ul>       	
                <b>1: </b>Selezionare il bottone <input type="button" value="Visualizza all"> sotto a "Quick address".<br>
                <b>2: </b>Apparir� una finestrella con gli indirizzi.<br>
                ...
                selezionare pi� di un indirizzo per volta.<p>
            ...
            <ul>       	
                <b>Nota: </b>"Quick address" mostra i primi cinque tra gli indirizzi e-mail che ha memorizzato.<p>
                    ...
                    <b>2: </b>A questo punto selezionare uno degli indirizzi della "Quick address": esso sar�
...
<?php endif; ?>	
    <?php if ($src == "read") : ?>
        ...
        <ul>       	
            ...
            <b>2: </b>Apparir� una finestrella con la versione stampabile della mail.<br>
        ...
        <ul>       	
            Nota: questa operazione � anche detta 'inoltro' o 'forward'.<br>
        ...
        <ul>       	
            ...
            <b>2: </b>Prima della cancellazione, sar� chiesta conferma.<br>
...
<?php if ($src == "address") : ?>
        ...
        <ul>       	
            ...
            <b>2: </b>Apparir� un modulo da riempire: inserire il nome nel campo "<span style="background-color:yellow" > Nome, Cognome: </span>".<br>
        ...
        <ul>       	
            ...
            <b>2: </b>Selezionare il bottone <input type="button" value="Cancella">.<br>
            <b>3: </b>Prima della cancellazione, sar� chiesta conferma.<br>
