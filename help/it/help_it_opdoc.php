    ...
    if ($src == "create") {
        switch ($x1) {
            ...
            case "": print "Creare un nuovo documento";
                break;
            case "saveok": print " - Il documento � stato salvato";
                break;
...
<form action="#" >
    ...
    <?php if ($x1 == "update") : ?>
            ...
            <ul>       	
                <b>1: </b>Dopo essere passati al modo modifica, � possibile modificare i dati.<br> 
            ...
            <ul>       	
                ...
                <ul>       	
                    <b>Nota: </b>Se la ricerca trova un solo risultato, i dati fondamentali del paziente saranno copiati nei campi appropriati.<p> 
                        <b>Nota: </b>Se invece ci sono pi� risultati, apparir� un elenco. Selezionare il cognome del paziente per selezionare la sua documentazione.<p> 
                </ul>
                <b>3: </b>Dopo aver caricato i dati fondamentali, � possibile aggiungere altre
            ...
            <ul>       	
                ...
                <ul>       	
                    <b>Nota: </b>Se la ricerca trova un solo risultato, i dati del paziente saranno visualizzati subito.<p> 
                        <b>Nota: </b>Se invece ci sono pi� risultati, apparir� un elenco. Selezionare il cognome del paziente, la data o il codice operazione per vedere la documentazione.<p> 
                </ul>
            </ul>
            <img <?php echo createComIcon('../', 'warn.gif', '0', 'absmiddle') ?>> <font color="#990000"><b> Nota:</b></font> 
            <ul>       	
...
<?php if ($src == "arch") : ?>
    <?php if (($x1 == "dummy") || ($x1 == "?") || ($x1 == "")) : ?>
            ...
            <ul> <b>1: </b>Inserire la chiave di ricerca nel campo appropriato. Pu� essere una parola completa,
                una frase o un insieme di lettere presenti nei dati personali del paziente. <br>
                <ul><font size=1 color="#000099" >
                    <b>Ecco i campi che � possibile usare come chiave:</b>
                    <br> Codice paziente
                    <br> Cognome
                    <br> Nome
                    <br> Data di nascita
            ...
            <ul> Si possono combinare pi� condizioni di ricerca, per esempio per trovare la lista dei pazienti interni operate dal medico "Bianchi" 
                e che hanno avuto una terapia che comincia per "lipo":<p>
                    ...
                    <b>Nota: </b>Se invece ci sono pi� risultati, apparir� un elenco.<br>
