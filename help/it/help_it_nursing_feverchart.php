        ...
        <?php elseif ($src == "discharge") : ?>
            ...
            <ul> <b>1: </b>Scegliere il tipo di dimissione premendo il bottone corrispondente<br>
                <ul><br>
                    ...
                    <input type="radio" name="relart" value="self"> Il paziente lascia l'ospedale di propria volont�<br>
                ...
                <b>3: </b>Inserire il proprio nome nel campo "<span style="background-color:yellow" > Assistente medico: <input type="text" name="a" size=20 maxlength=20></span>" se questo � vuoto. <br>
            ...
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Ho clickato il bottone <input type="button" value="dimetti">, ma non � successo niente: perch�?</b></font>
            <ul> E' necessario che la casella <br>
                ...
                Se non lo �, occorre selezionarla.
            </ul>
            <b>Nota: </b>Per annullare l'operazione, clickare il bottone <img <?php echo createLDImgSrc('../', 'cancel.gif', '0') ?> border=0 align="absmiddle">.</ul>
        <?php endif; ?>
    </form>
