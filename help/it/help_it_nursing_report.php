...
<un name="howto">
    ...
    <b><?php if ($x1 == "docs") print "Prescrizioni mediche";
else print "Referto infermieristico"; ?></b></font>
    <form action="#" >
        <p><font size=2 face="verdana,arial" >

<?php if ($src == "") : ?>
                <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                    Come fare a: enter a <?php if ($x1 == "docs") print "Prescrizioni mediche";
    else print "relazione infermieristica"; ?>?</b></font>
            <ul> 
                <b>1: </b>Inserire la data nel campo "<span style="background-color:yellow" > Data: <input type="text" name="d" size=10 maxlength=10 value="10.10.2002"> </span>" nel campo "<?php if ($x1 == "docs") print "Prescrizioni mediche";
    else print "Referto infermieristico"; ?>".<br>
                ...
                <b>2: </b>Inserire l'ora nel campo "<span style="background-color:yellow" > Ora: <input type="text" name="d" size=5 maxlength=5 value="10.35"> </span>" nel campo "<?php if ($x1 == "docs") print "Prescrizioni mediche";
    else print "Referto infermieristico"; ?>".<br>
                ...
                <b>3: </b>Inserire la <?php if ($x1 == "docs") print "prescrizione medica";
    else print "relazione infermieristica"; ?> nel campo "<span style="background-color:yellow" > <?php if ($x1 == "docs") print "Prescrizioni mediche";
    else print "Referti infermieristici"; ?>: <input type="text" name="d" size=10 maxlength=10 value="test report"> </span>".<br>
                <font color="#000099" size=1><b>Note:</b>
                <ul type=disc>
                    <li>Selezionare la casella "<span style="background-color:yellow" > <input type="checkbox" name="c" value="c"> <img <?php echo createComIcon('../', 'warn.gif', '0') ?>>Inserire il simbolo all'inizio. </span>", se si desidera che il simbolo <img <?php echo createComIcon('../', 'warn.gif', '0') ?>> appaia all'inizio della <?php if ($x1 == "docs") print "prescrizione medica";
    else print "relazione infermieristica"; ?>.
            ...
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Come fare a: inserire <?php if ($x1 == "docs") print "una domanda per il medico";
    else print "un rapporto di efficacia terapeutica"; ?>?</b></font>
            <ul> 
                <b>1: </b>Inserire la data nel campo "<span style="background-color:yellow" > Data: <input type="text" name="d" size=10 maxlength=10 value="10.10.2002"> </span>" nel campo "<?php if ($x1 == "docs") print "Domande per il medico";
    else print "Rapporto sull'efficacia"; ?>".<br>
                <font color="#000099" size=1><b>Note:</b>
                <ul type=disc>
                    <li>Inserire "O" oppure "o" (oggi) per usare automaticamente la data odierna.<br>
                    <li>In alternativa usare il bottone <img <?php echo createComIcon('../', 'arrow-t.gif', '0') ?>> sotto al campo.
                ...
                <b>2: </b>Inserire <?php if ($x1 == "docs") print "la domanda";
    else print "il rapporto sull'efficacia"; ?> nel campo "<span style="background-color:yellow" > <?php if ($x1 == "docs") print "Domande per il medico";
    else print "Rapporto sull'efficacia"; ?>: <input type="text" name="d" size=10 maxlength=10 value="test report"> </span>".<br>
                <font color="#000099" size=1><b>Note:</b>
                <ul type=disc>
                    <li>Selezionare la casella "<span style="background-color:yellow" > <input type="checkbox" name="c" value="c"> <img <?php echo createComIcon('../', 'warn.gif', '0') ?>> Inserisci il simbolo all'inizio. </span>", se si desidera che il simbolo <img <?php echo createComIcon('../', 'warn.gif', '0') ?>> appaia all'inizio <?php if ($x1 == "docs") print "della domanda";
    else print "del rapporto sull'efficacia"; ?>.
                    <li>Se si desidera evidenziare parte <?php if ($x1 == "docs") print "della prescrizione o"; ?> del rapporto, selezionare l'icona <img <?php echo createComIcon('../', 'hilite-s.gif', '0') ?>> prima di inserire la parola o frase.
                        Per terminare l'evidenziazione, selezionare l'icona <img <?php echo createComIcon('../', 'hilite-e.gif', '0') ?>> dopo aver inserito l'ultimo carattere da evidenziare.
                        </font>
                </ul>
            ...
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Nota:</b></font>
            <ul> 
                E' anche possibile inserire <?php if ($x1 == "docs") print "sia prescrizioni mediche che domande per il medico";
        else print "i rapporti sia infermieristico che sull'efficacia terapeutica"; ?>.</ul>
<?php endif; ?>
<?php if ($src == "diagnosis") : ?>
            <un name="extra"><un name="diag"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b></a></a>
                    ...
                    <ul> 
                        <b>Nota: </b>Se � disponibile un report diagnostico, nella colonna a sinistra appariranno delle brevi note sulla data di creazione ed il reparto/clinica che lo ha prodotto.<p>
                            <b>Nota: </b>Il primo report della lista sar� mostrato subito.<p>
...
<?php if ($src == "fotos") : ?>
                        <un name="coag"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b></a>
                            ...
                            <ul> 
                                <b>1: </b>Selezionare una delle piccole immagini nel riquadro a sinistra: a destra apparir� l'immagine a dimensione piena, completa di data e numero della foto.<br>
                            </ul>
<?php endif; ?>
...
<?php if ($src == "medication") : ?>
    ...
    <?php if ($x2) : ?>
                                            <un name="daymed"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b></a>
                                                ...
                                                <ul> 
                                                    ...
                                                    <b>Nota: </b>Se si desidera annullare, premere il bottone <img <?php echo createLDImgSrc('../', 'cancel.gif', '0') ?> align="absmiddle">.<br>
                                                    <b>3: </b>E' possibile inserire pi� dati e salvare solo alla fine.<br>
                                                    <b>4: </b>Premere il bottone <img <?php echo createLDImgSrc('../', 'savedisc.gif', '0') ?>> per salvare le informazioni.<br>
    ...
    <?php else : ?>
                                                <un name="daymed"><img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b></a>
                                                        Dice "Non c'� ancora un medicinale". Che devo fare?</b></font>
                                                    <ul> 
                                                        ...
                                                        <b>3: </b>Apparir� una finestrella che permette di inserire medicinali e piani di dosaggio.<br>
