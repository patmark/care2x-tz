    ...
    <?php if ($src == "access") : ?>
        <?php if ($x1 == "") : ?>
            ...
            <ul>       	
                ...
                <b>2: </b>Inserire lo username nel campo "<span style="background-color:yellow" > Login </span>".<p>
                    ...
                    <b>4: </b>Scegliere le aree a cui l'utente pu� accedere nel campo "<span style="background-color:yellow" > # Area </span>".<p>
                    <b>Nota:</b> ogni utente pu� accedere ad un massimo di dieci aree (da Area 1 ad Area 10).<p>
            </ul>
        ...
        <?php if ($x1 == "save") : ?>
            ...
            <ul>       	
                ...
                <b>2: </b>Apparir� il modulo per inserire i nuovi dati.<br>
        ...
        <?php if ($x1 == "list") : ?>
            ...
            <ul>       	
                <img <?php echo createComIcon('../', 'padlock.gif', '0', 'absmiddle') ?>> = I privilegi dell'utente sono bloccati o "congelati", quindi non pu� accedere alle aree.<br>
                <img <?php echo createComIcon('../', 'arrow-gr.gif', '0', 'absmiddle') ?>> = I privilegi dell'utente non sono bloccati: l'accesso alle aree abilitate � possibile.<br>
            </ul>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
        ...
        <?php if ($x1 == "cancellare") : ?>
            ...
            <ul>       	
                <b>1: </b>se si � sicuri della cancellazione,<br>
                selezionare il bottone <input type="button" value="S�, sono sicuro: cancella i diritti di accesso.">.<br>
            </ul>
            <img <?php echo createComIcon('../', 'warn.gif', '0', 'absmiddle') ?>> <font color="#990000"><b>
                Nota:</b>
            </font>
        ...
        <?php if ($x1 == "lock") : ?>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Come fare a: <?php if ($x2 == "0") print "bloccare";
        else print "sbloccare"; ?> i diritti di accesso?</b>
            </font>
            <ul>       	
                <b>1: </b>Se si � sicuri di <?php if ($x2 == "0") print "bloccare";
        else print "sbloccare"; ?> i diritti di accesso,<br>
                selezionare il bottone <input type="button" value="S�">.<br>
            </ul>
            <img <?php echo createComIcon('../', 'warn.gif', '0', 'absmiddle') ?>> <font color="#990000"><b>
                Nota:</b>
            </font>
            <ul>       	
                E' possibile annullare <?php if ($x2 == "0") print "il blocco";
        else print "lo sblocco"; ?> selezionando il bottone <input type="button" value="No. Indietro.">.<br>
            </ul>
