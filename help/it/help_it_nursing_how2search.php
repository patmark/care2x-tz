...
<b>
    ...
    switch ($x2) {
        case 'search': print 'Come fare a: ';
            if ($x1)
                print 'mostrare la lista occupazione letti del padiglione identificato dalla ricerca';
            else
                print 'cercare un paziente';
            break;
...
<form action='#' >
    ...
    <?php if (!$x1) : ?>
            ...
            <b>3</b>
            <ul> Se la ricerca trova un solo risultato, apparir� la lista di occupazione del padiglione identificato dalla ricerca.<p>
            </ul>
            <b>4</b>
            <ul> Se la ricerca trova pi� risultati, apparir� una lista.<p>
            </ul>
            <b>Nota</b>
            <ul> Per annullare la ricerca premere il bottone <img <?php echo createLDImgSrc('../', 'cancel.gif', 'absmiddle') ?>>.
            </ul><?php endif; ?>
        <b><?php if ($x1) print '1';
    else print '5'; ?></b><ul>Premere il bottone <img <?php echo createComIcon('../', 'bul_arrowblusm.gif', 'absmiddle') ?>>,
            o la data , o il padiglione per mostrare la lista di occupazione.
            <p><b>Nota:</b> nella lista la chiave di ricerca apparir� evidenziata.
                <br><b>Nota:</b> La lista non � modificabile: se si tenta di aprire la cartella dati di un paziente selezionando il nome,
                sar� richiesto di inserire username e password.
        </ul>
    <?php endif; ?>
<?php if ($x2 == 'quick') : ?>
    <?php if ($x1) : ?>
            ...
            <ul>       	
                ...
                <b>Nota: </b>La lista di occupazione visualizzata � di 'sola lettura'. non � possibile modificare i dati dei pazienti.<br>
            </ul>
            <img <?php echo createComIcon('../', 'frage.gif', 'absmiddle') ?>> <font color='#990000'><b>
            ...
            <ul>       	
                ...
                <b>2: </b>Se si � gi� effettuato il login e si hanno i diritti di accesso sufficienti, apparir� subito la lista di occupazione.<br>
                Altrimenti, sar� richiesto di inserire username e password.<br>
                <b>3: </b>Inserire se richiesto username e password.<br>
                <b>4: </b>Premere il bottone <input type='button' value='Continua...'>.<br>
                <b>5: </b>Se si hanno i diritti di accesso sufficienti, apparir� la lista di occupazione.<br>
                <b>Nota: </b>La lista di occupazione visualizzata � modificabile. Saranno presenti anche le opzioni per la modifica dei dati paziente.
    ...
    <?php else : ?>
            <img <?php echo createComIcon('../', 'warn.gif', 'absmiddle') ?>> <font color='#990000'><b>
                Al momento non c'� una lista di occupazione!</b>
            </font><p>
                <img <?php echo createComIcon('../', 'frage.gif', 'absmiddle') ?>> <font color='#990000'><b>
            ...
            <ul>       	
                ...
                <b>2: </b>Apparir� un calendario.<br>
