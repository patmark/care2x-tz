...
<form action="#" >
    <p><font size=2 face="verdana,arial" >
        ...
        <ul> <b>1: </b>Selezionare il <img <?php echo createComIcon('../', 'plus2.gif', '0') ?>> corrispondente alla stanza ed al letto.<br>
            <b>2: </b>Apparir� una finestrella per cercare il paziente.<br>
            <b>3: </b>Prima di tutto cercare il paziente inserendo una chiave di ricerca in uno o pi� campi.<br>
            ...
            <b>5: </b>Se la ricerca trova uno o pi� pazienti, apparir� un elenco.<br>
        ...
        <ul> <b>1: </b>Selezionare <img <?php echo createComIcon('../', 'bestell.gif', '0') ?>> corrispondente al paziente.<br>
            <b>2: </b>Apparir� il modulo di scarico del paziente.<br>
            <b>3: </b>Se si vuole effettuare lo scarico, <br>selezionare  
            "<input type="checkbox" name="g" ><span style="background-color:yellow" > S�, il paziente non � pi� in carico.</span>".<br>
        ...
        <ul> <b>Nota: </b>NON si pu� semplicemente cancellare un paziente dalla lista. Prima di tutto, bisogna effettuare
        ...
        <ul> <b>Nota: </b>Ciascuna barra colorata quando "visibile" indica la disponibilit� di informazioni specifiche, istruzioni, cambiamenti, domande, etc.<br>
            Il significato di un colore � modificabile per ciascuna corsia. 
        </ul>
        ...
        <ul> <b>Nota: </b>E' il bottone dell'archivio dati paziente. Per aprire la cartella dati, selezionare questa icona. Apparir� una finestrella
        ...
        <ul> <b>Nota: </b>E' il bottone di lettura/scrittura note: selezionandola apparir� una finestrella che permette di leggere o scrivere note sul paziente.<br>
    ...
    <?php elseif (($src == "") && ($x1 == "template")) : ?>
        ...
        <ul> <b>1: </b>Premere il bottone <input type="button" value="Visualizza l'ultima lista di occupazione"> per trovare l'ultima lista registrata.<br>
            <b>2: </b>Se esiste una lista creata negli ultimi 31 giorni, essa sar� visualizzata.<br>
    ...
    <?php elseif ($src == "assign") : ?>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Come fare a: assegnare un letto a un paziente?</b></font>
        <ul> <b>1: </b>Prima di tutto cercare il paziente inserendo una chiave di ricerca in uno o pi� campi.<br>
            Se si vuole cercare il paziente...<ul type="disc">
                <li>tramite il codice paziente, inserirlo nel campo <br>"<span style="background-color:yellow" >Codice paziente:</span><input type="text" name="t" size=19 maxlength=10 value="22000109">".
                <li>tramite il cognome, inserirlo (bastano poche lettere) nel campo <br>"<span style="background-color:yellow" >Cognome:</span><input type="text" name="t" size=19 maxlength=10 value="Rossi">".
                <li>tramite il nome, inserirlo (bastano poche lettere) nel campo <br>"<span style="background-color:yellow" >nome:</span><input type="text" name="t" size=19 maxlength=10 value="Mario">".
            ...
            <b>3: </b>Se la ricerca trova uno o pi� pazienti, apparir� un elenco.<br>
    ...
    <?php elseif ($src == "discharge") : ?>
        ...
        <ul> <b>1: </b>Scegliere il tipo di dimissione selezionando il bottone corrispondente<br>
            ...
            <b>3: </b>Inserire il proprio nome nel campo "<span style="background-color:yellow" > Infermiere/a: <input type="text" name="a" size=20 maxlength=20></span>" se � vuoto. <br>
            <b>4: </b>Selezionare " <span style="background-color:yellow" ><input type="checkbox" name="d" value="d"> S�, dimetti il paziente. </span>". <br>
        ...
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Ho provato a selezionare il bottone <input type="button" value="discharge">, ma senza effetto. Perch�?</b></font>
        <ul> <b>Nota: </b>c'� una casella da selezionare, che deve apparire cos�:<br>
            " <span style="background-color:yellow" ><input type="checkbox" name="d" value="d" checked> S�, dimetti il paziente. </span>". <p>
                <b>1: </b>Selezionare la casella se non lo � gi�.<p>
        </ul>
    ...
    <?php if (($src != "assign") && ($src != "remarks") && ($src != "discharge")) : ?>
        ...
        <ul> <b>Nota: </b>Significa che il letto � bloccato e non pu� essere assegnato. Per sbloccarlo, selezionare "<span style="background-color:yellow" ><font color="#0000ff">Bloccato</font></span>" e premere &nbsp;<button>OK</button>
            per confermare.<br>
