...
<?php if ($src == "search") : ?>
        ...
        <ul>       	
            ...
            <b>4: </b>Se la ricerca trova pi� di un articolo, apparir� un elenco.<br>
        </ul>
    <?php if ($x1 != "multiple") : ?>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
    ...
    <?php if ($x1 == "multiple") : ?>
            ...
            <ul>       	
                ...
                <b>2: </b>Sar� chiesta conferma prima della cancellazione<br>
    ...
    <?php if (($x1 != "multiple") && ($x3 == "")) : ?>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                La lista contiene pi� articoli: come fare a visualizzarne uno in particolare?</b>
            </font>
            <ul>       	
                <b>1: </b>Selezionare o il bottone <img <?php echo createComIcon('../', 'info3.gif', '0') ?>> o il nome.<br>
            </ul>
