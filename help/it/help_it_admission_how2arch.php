...
<form action="#" >
    ...
    <?php elseif ($src == "search") : ?>
        <b>Nota</b>
        <ul>Se la ricerca trova un solo risultato, questo sar� mostrato immediatamente;<br>
            in caso di pi� risultati apparir� invece una lista.<br>
    ...
    <?php else : ?>
        ...
        <ul> <b>1: </b>Inserire la parola chiave nel campo corrispondente. Non � necessario sia una parola intera, bastano poche lettere. <br>
            <ul><font size=1 color="#000099" >
        ...
        <ul> <b>1: </b>Inserire la parola chiave nel campo corrispondente. Non � necessario sia una parola intera, bastano poche lettere. <br>
            <ul><font size=1 color="#000099" >
                <b>Ecco i campi che � possibile usare come chiavefields can be filled with a keyword:</b>
                <br> Codice paziente
                <br> Cognome
                <br> Nome
                <br> Data di nascita
