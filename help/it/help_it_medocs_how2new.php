...
<form action="#" >
    <?php if ($src == "?") : ?>
        ...
        <ul>Trovare i dati fondamentali di un paziente.<br>
            ...
            <Ul type="disc">
                ...
                <li>il nome<br>
                    ...
                    <b>Nota:</b>Se il sistema � dotato di lettore di codici a barre, selezionare il campo "Documenti del seguente paziente:"
        ...
        <b>3</b>
        <ul> Se la ricerca trova un solo risultato, apparir� una pagina con i dati fondamentali del paziente.
            Se invece la ricerca trova pi� risultati, apparir� un elenco.
        <?php endif; ?>
        <?php if (($src == "?") || ($x1 > 1)) : ?>
    ...
    <?php endif; ?>
    <?php if (($x1 == "1") || ($src == "?")) : ?>
        <ul> Una volta che � apparso il modulo con i dati paziente, � possibile: 
            <Ul type="disc">		
                <li>inserire ulteriori informazioni sull'assicurazione nel campo "Informazioni aggiuntive:",<br>
                <li>selezionare "<span style="background-color:yellow" ><input type="radio" name="n" value="a">S�</span>" nei campi "Medical advice" se il paziente ha ricevuto le informative,<br>
