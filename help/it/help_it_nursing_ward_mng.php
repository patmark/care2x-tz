...
<form action="#" >
    ...
    <ul>Se si desidera bloccare uno o pi� letti in una sola volta, selezionare questa opzione. Apparir� il padiglione attualmente attivo o, se non disponibile,
...
<?php if ($x2 == "quick") : ?>
    <?php if ($x1) : ?>
        ...
        <ul>       	
            ...
            Otherwise,  sar� richiesto di inserire username e password.<br>
...
<?php if ($src == "new") : ?>
    ...
    <ul>       	
        <b>No. </b>In questa versione del programma il numero di letti per stanza � fisso a due e non lo si pu� cambiare.<br>
    </ul>
    <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
        Posso stabilire il prefisso o codice di un letto?</b>
    </font>
    <ul>       	
        <b>No. </b>In questa versione del programma il prefisso pu� essere soltanto 'a' oppure 'b'.<br>
    </ul>
    <b>Nota</b>
    <ul> Per annullare premere il bottone <img <?php echo createLDImgSrc('../', 'cancel.gif', '0') ?> border=0>.
    </ul>
