...
<form action="#" >
    <p><font size=2 face="verdana,arial" >
        ...
        <ul> <b>Nota: </b>Ciascuna barra colorata se resa "visibile" indica la disponibilit� di informazioni specifiche, prescrizioni, cambiamenti, domande, etc.<br>
            Il significato di un colore � modificabile per ciascun padiglione. <br>
            La serie di barre colorate rosa a destra rappresenta l'orario approssimato in cui � necessario eseguire una prescrizione.<br>
        ...
        <ul> <input type="button" value="Grafico andamento febbre">
            <ul>
                Questo apre il grafico giornaliero della temperatura. Da qui � possibile inserire, modificare, o cancellare dati.<br>
            ...
            <ul>
                ...
                attivit� infermieristica e la sua efficacia, osservazioni, domande, raccomandazioni, etc.
            </ul>
            <input type="button" value="Prescrizioni mediche">
            <ul>
                Il medico responsabile inserir� qui prescrizioni, medicinali, dosaggio, risposte alle domande del pers.
            ...
            <ul>
                Questo � il piano di cura individuale: da qui lo si pu� creare, modificare o cancellare.
            </ul>	
        ...
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Qual'� la funzione del riquadro di selezione </b>	<select name="d"><option value="">Scegliere richiesta di test diagnostici</option></select>?
        </font>
        <ul><b>Nota: </b>Questo apre il modulo di richiesta per un particolare test diagnostico.<br>
            ...
            <b>3: </b>A questo punto apparir� il modulo di richiesta.<br>
        </ul>
    <?php endif; ?>
    <?php if ($src == "labor") : ?>
