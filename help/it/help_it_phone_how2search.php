...
<b>Come
    <?php
    switch ($src) {
        case "search": print 'cercare un numero di telefono';
            break;
        case "dir": print "aprire tutto l 'elenco'";
            break;
        case "newphone": print 'inserire un nuovo numero';
            break;
    }
    ?></b></font>
...
<?php if ($src == "newphone") : ?>
        ...
        <b>2:</b>
        <ul> Se si � fatto login precedentemente e si hanno i diritti di accesso sufficienti, apparir� un
