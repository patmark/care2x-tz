...
<form action="#" >
    <p><font size=2 face="verdana,arial" >
        ...
        <ul>      
            ...
            <b>2: </b>Per visualizzare pi� di un parametro per volta, selezionare le caselle corrispondenti.<br>
            <b>3: </b>Selezionare l'icona <img src="../img/chart.gif" width=16 height=17 border=0> per visualizzare il grafico.<br>
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            C'� un modo rapido per selezionare tutti i parametri?</b>
        </font>
        <ul>      
            <b>S�!</b><br>
        ...
        <ul>      
            <b>1: </b>Selezionare il bottone <img <?php echo createComIcon('../', 'dwnarrowgrnlrg.gif', '0') ?> border=0> di nuovo. Questo deselezioner� tutti i parametri.<br>
        </ul>
    <?php endif; ?>
    <?php if ($src == "graph") : ?>
