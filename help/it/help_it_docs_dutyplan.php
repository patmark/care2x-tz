...
<form action="#" >
    ...
    <ul><b>2:</b>
        Se si � fatto login precedentemente e si hanno i privilegi di accesso sufficienti, the 
    ...
    <ul> <b>1: </b><span style="background-color:yellow" >Click on the person's name</span>: apparir� una finestrella con tutte le informazioni necessarie.<br>
    </ul>
    <b>Nota</b>
