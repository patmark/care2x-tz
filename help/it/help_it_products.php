...
<b>
    ...
    if ($x2 == "pharma")
        ...
        echo "Deposito medicinali - ";
    switch ($src) {
        case "head": if ($x2 == "pharma")
                echo "Ordinare prodotti farmaceutici";
            else
                echo "Ordine prodotti";
            break;
...
<?php if ($src == "maincat") : ?>
        ...
        <ul>       	
            <b>1: </b>Prima di tutto � necessario trovare l'articolo: inserire i dati completi (bastano poche lettere) della Casa, del nome, del codice ordine, etc. nel campo 
        ...
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            La ricerca ha identificato pi� articoli che soddisfano i miei criteri. Che devo fare?</b>
        </font>
        <ul>       	
        ...
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Desidero vedere pi� informazioni sull'articolo. Che devo fare?</b>
        </font>
        <ul>       	
...
<?php if ($src == "how2") : ?>
    ...
    else echo "prodotto dal deposito medicinali"; ?>?
        </b>
        </font>
        <ul>       	
            ...
            <b>2: </b>Se si � gi� effettuato il login, appariranno il catalogo ordini e la lista ordini. In caso contrario, il sistema chieder� username
            e  password.<br>
            ...
            il catalogo ordini del dipartimento, o corsia, o sala operatoria.<p>
                <b>5: </b>Se l'articolo richiesto � nella lista, selezionare il corrispondente bottone <img <?php echo createComIcon('../', 'l-arrowgrnlrg.gif', '0') ?>> per mettere <b>un pezzo</b> dell'articolo nell'ordine presente nel riquadro a sinistra.<p>
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Desidero mettere pi� di un pezzo dell'articolo nell'ordine. Come fare?</b>
        </font>
        <ul>       	
        ...
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            L'articolo non � a catalogo. Che devo fare?</b>
        </font>
        <ul>       	
            ...
            <nobr><span style="background-color:yellow" >" Chiave di ricerca: <input type="text" name="s" size=10 maxlength=10> "</span></nobr>.<br>
            <b>2: </b>Premere il bottone <input type="button" value="Trova articolo"> per trovare l'articolo.<br>
            <b>3: </b>Se la ricerca trova pi� di un articolo, apparir� un elenco.<br>
        ...
        <ul>       	
            <b>1: </b>Selezionare o il bottone <img <?php echo createComIcon('../', 'info3.gif', '0') ?>> o il nome.<br>
            <b>2: </b>Apparir� una finestrella con tutte le informazioni sull'articolo.<br>
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Come fare a: rimuovere un articolo dal catalogo?</b>
        </font>
        ...
        <ul>       	
            <b>S�:</b> basta sostituire il valore corrente con quello desiderato prima di chiudere la lista.
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            L'ordine � completo: cosa faccio ora?</b>
        </font>
        <ul>       	
            <b>1: </b>Si pu� procedere inviando l'ordine <?php if ($x2 == "pharma") echo "alla farmacia";
    else echo "al deposito medicinali"; ?>. <br>Premere il bottone <input type="button" value="Chiudere ordine"> per avviare la procedura.<br>
            <b>2: </b>L'elenco apparir� di nuovo: inserire il proprio nome nel campo <nobr>"<span style="background-color:yellow" > Creato da <input type="text" name="c" size=15 maxlength=10> </span>"</nobr>.<br>
            <b>3: </b>Scegliere la priorit� dell'ordine da "<span style="background-color:yellow" > Normale<input type="radio" name="x" value="s" checked> Urgente<input type="radio" name="x" > </span>" tramite la casella pi� adatta.<br>
            ...
            <b>6: </b>Premere il bottone <input type="button" value="Inviare l'ordine <?php if ($x2 == "pharma") echo "alla farmacia";
    else echo "al deposito medicinali"; ?>"> per spedire la lista.<br>
        </ul>
        ...
        <ul>     
            <b>1: </b>Selezionare il link "<span style="background-color:yellow" > <img <?php echo createComIcon('../', 'arrow-blu.gif', '0') ?>> Chiudere ordine </span>" per tornare al menu <?php if ($x2 == "pharma") echo "farmacia";
    else echo "deposito medicinali"; ?>.<br>
        </ul>	
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
...
<?php if ($src == "head") : ?>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Come fare a: ordinare <?php if ($x2 == "pharma")
        echo "prodotti farmaceutici";
    else
        echo "prodotti del deposito medicinali";
    ?>?
        </b>
        </font>
        <ul>       	
            <b>1: </b>Prima di tutto creare una lista. A destra apparir� il 
            catalogo ordini del dipartimento, della corsia, o della sala 
            operatoria.<p>
                <b>2: </b>Se l'articolo richiesto � nel catalogo, premere il suo bottone <img <?php echo createComIcon('../', 'l-arrowgrnlrg.gif', '0') ?>> per mettere <b>un pezzo</b> dell'articolo nell'ordine presente nel riquadro a sinistra.<p>
        </ul>
        <img <?php echo createComIcon('../', 'warn.gif', '0', 'absmiddle') ?>> <font color="#990000"><b> Nota:</b></font> 
        <ul>       	
            Premendo il bottone <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> si otterranno informazioni dettagliate sul catalogo o sull'ordine.
...
<?php if ($src == "catalog") : ?>
        ...
        <ul>       	
            <b>1: </b>Se l'articolo richiesto � nel catalogo, premere il suo bottone <img <?php echo createComIcon('../', 'l-arrowgrnlrg.gif', '0') ?>> per mettere <b>un pezzo</b> dell'articolo nell'ordine presente nel riquadro a sinistra.<p>
        </ul>

        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Desidero mettere pi� di un pezzo nell'ordine. Come fare?</b>
        </font>
        <ul>       	
            <b>1: </b>Selezionare la casella <input type="checkbox" name="a" value="a" checked> corrispondente all'articolo da scegliere.<br>
            <b>2: </b>Inserire il quantitativo nel campo "Pezzi<input type="text" name="d" size=2 maxlength=2> " corrispondente all'articolo.<br>
        ...
        <ul>       	
            ...
            <b>2: </b>Premere il bottone <input type="button" value="Trova articolo"> per trovare l'articolo.<br>
            <b>3: </b>Se la ricerca identifica un solo articolo, saranno visualizzate informazioni dettagliate.<br>
            <b>4: </b>Se si desidera inserire un solo pezzo nell'ordine, selezionare il bottone <img <?php echo createComIcon('../', 'l-arrowgrnlrg.gif', '0') ?>>. L'articolo sar� aggiunto sia all'ordine che nel catalogo.<br>
...
<?php if ($src == "orderlist") : ?>
    <?php if ($x1 == "0") : ?>
            ...
            <ul>       	
                <b>1: </b>Se l'articolo richiesto � nel catalogo, premere il suo bottone <img <?php echo createComIcon('../', 'l-arrowgrnlrg.gif', '0') ?>> to put <b>one piece</b> dell'articolo to the order list (basket).
                <br> Apparir� automaticamente la lista nel riquadro a sinistra.<p>
            </ul>
            <img <?php echo createComIcon('../', 'warn.gif', '0', 'absmiddle') ?>> <font color="#990000"><b> Nota:</b></font> 
            <ul>       	
    ...
    <?php else : ?>
            ...
            <ul>       	
                <b>S�: basta sostituire il valore corrente con quello desiderato prima di chiudere la lista.</b>
            </ul>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Desidero vedere pi� informazioni sull'articolo. Che devo fare?</b>
            </font>
            ...
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                L'ordine � completo: che faccio ora?</b>
            </font>
            <ul>       	
                <b>1: </b>Si pu� procedere inviando l'ordine alla farmacia. <br>Premere il bottone <input type="button" value="Chiudere ordine"> per avviare la procedura.<br>
                <b>2: </b>L'elenco apparir� di nuovo: inserire il proprio nome nel campo <nobr>"<span style="background-color:yellow" > Creato da <input type="text" name="c" size=15 maxlength=10> </span>"</nobr>.<br>
                <b>3: </b>Scegliere la priorit� dell'ordine da "<span style="background-color:yellow" > Normale<input type="radio" name="x" value="s" checked> Urgente<input type="radio" name="x" > </span>" tramite la casella pi� adatta.<br>
                <b>4: </b>Chi convalida l'ordine (medico o chirurgo) deve inserire il proprio nome nel campo <nobr>"<span style="background-color:yellow" > Convalidato da <input type="text" name="c" size=15 maxlength=10> </span>"</nobr>.<br>
                <b>5: </b>Chi convalida l'ordine (medico o chirurgo) deve inserire la propria password nel campo <nobr>"<span style="background-color:yellow" > Password: <input type="text" name="c" size=15 maxlength=10> </span>"</nobr>.<br>
...
<?php if ($src == "final") : ?>
    <?php if ($x1 == "1") : ?>
            ...
            <ul>       	
                ...
                <b>2: </b>Scegliere la priorit� dell'ordine da "<span style="background-color:yellow" > Normale<input type="radio" name="x" value="s" checked> Urgente<input type="radio" name="x" > </span>" tramite la casella pi� adatta.<br>
...
<?php if ($src == "arch") : ?>
        ...
        <ul>  	<b>1: </b> Inserire o i dati completi (bastano poche lettere) del nome dipartimento, identificativo, data dell'ordine o priorit� (es "urgente") nel campo 
            <nobr><span style="background-color:yellow" >" Chiave di ricerca: <input type="text" name="s" size=10 maxlength=10> "</span></nobr>.<br>
            ...
            <ul> 	
                ...
                <input type="checkbox" name="d" checked> Priorit�<br>
            ...
            <b>4: </b>Se la ricerca identifica uno o pi� ordini, apparir� un elenco.<br>
...
<?php if ($src == "db") : ?>
    <?php if ($x1 == "") : ?>
            ...
            <ul>       	
                ...
                <b>2: </b>Apparir� una finestrella con le immagini: scegliere quella che si desidera e premere "OK".<br>
            </ul>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
    ...
    <?php if ($x1 == "save") : ?>
            ...
            <ul>       	
                ...
                <b>2: </b>Apparir� il modulo di inserimento dati.<br>
