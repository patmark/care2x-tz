...
<form action="#" >
    <?php if ($src == "input") : ?>
        ...
        <ul>       	
            ...
            <b>2: </b>Apparir� la finestrella "Selezione file". Segliere il file da archiviare e premere "Apri".<br>
            <b>3: </b>Se il file selezionato � in un formato grafico valido, apparir� l'anteprima dell'immagine nell'angolo in alto a destra. Altrimenti, ripetere i passi 1 e 2.<br>
            <b>4: </b>Inserire la data in cui la foto � stata scattata nel campo "<span style="background-color:yellow" > Data foto </span>".<p>
                <img src="../img/warn.gif" border=0> <b>Attenzione! </b>La data pu� essere modificata se si sceglie la funzione 'data' nei dati paziente in basso a destra .<br>
                ...
                <img src="../img/warn.gif" border=0> <b>Attenzione! </b>Se si desidera scegliere questa foto come "foto principale", inserire 'main' invece del numero; la  "foto principale" � quella che appare sulla
            ...
            <font color="#990000">Che cosa fare dopo?</font><p>
                ...
                <b>8: </b>Quando si � trovato il paziente, i suoi dati appariranno nei campi appropriati.<br>
        ...
        <ul>       	
            <b>No. </b>In questa versione del programma, � possibile salvare le foto di un paziente solo se esiste un codice valido.<br>
        </ul>
    <?php endif; ?>	
    <?php if ($src == "maindata") : ?>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
        ...
        <ul>	
            ...
            apparir� automaticamente nel campo "Data foto" nel riquadro a sinistra.<p>
                <img src="../img/warn.gif" border=0><b> Attenzione! </b>Se ci sono delle foto con data differente, modificare il campo "Data foto":
                lo si pu� fare quando si � ultimato il passo 5.<p>
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
            Non riesco a trovare il paziente tramite il codice: non posso inserire semplicemente i dati a mano e salvare le foto?</b>
        </font>
    ...
    <?php if ($src == "init") : ?>
        <?php if ($x1 == "") : ?>
            ...
            <ul>       	
                ...
                <b>3: </b>Apparir� il modulo di inserimento foto. Premere il bottone "Aiuto" per altre istruzioni.<br>
            </ul>
        <?php endif; ?>	
    <?php endif; ?>	
</form>
