...
switch ($x1) {
    case "entry": print $foreword . 'sebuah penerimaan pasien baru ';
        break;
    case "search": print $foreword . 'pencarian data penerimaan untuk seorang pasient';
        break;
    case "archiv": print $foreword . 'Pencarian kebali dalam arsif';
        break;
}
?>
...
<?php else : ?>
    ...
    <?php if ($src != $x1) : ?>
        ...
        <ul>
            ...
            switch ($x1) {
                case "entry": echo createLDImgSrc('../', 'ein-gray.gif', '0');
                    break;
                case "search": echo createLDImgSrc('../', 'such-gray.gif', '0');
                    break;
                case "archiv": echo createLDImgSrc('../', 'arch-gray.gif', '0');
                    break;
            }
            ?> border="0">. 
        </ul>
    ...
    <ul> Jika anda telah login sebelumnya dan anda mempunyai hak akses untuk fungsi ini,
        <?php
        switch ($x1) {
            case "entry": print 'form penerimaan pasien';
                break;
            case "search": print 'field pencarian';
                break;
            case "archiv": print 'field pencarian arsif';
                break;
        }
