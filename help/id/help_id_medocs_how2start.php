...
switch ($x1) {
    case "entry": print $foreword . 'sebuah medocs dokumen baru';
        break;
    case "search": print $foreword . 'sebuah pencarian untuk sebuah medocs dokumen';
        break;
    case "archiv": print $foreword . 'pencarian kebali dalam arsif medocs ';
        break;
}
?>
...
<?php else : ?>
    ...
    <?php if ($src != $x1) : ?>
            <b>Langkah 1</b> 
        <ul>
            Klik Tombol <img src="../img/id/id<?php
            switch ($x1) {
    ...
    <ul> Jika anda telah login sebelumnya dan anda mempunyai hak akses untuk fungsi ini,
        <?php
        switch ($x1) {
            case "entry": print 'form inisial document ';
                break;
            case "search": print 'pencarian field ';
                break;
            case "archiv": print 'pencarian field arsif ';
                break;
        }
