    ...
    <table border=0 cellspacing=0 cellpadding=0 <?php echo $this->_tpl_vars['sFormWidth']; ?>
        ...
        <?php if ($this->_tpl_vars['LDBloodGroup']): ?>
            <tr>
                ...
                <td colspan=2 class="reg_input">
                    <?php
                    echo $this->_tpl_vars['sBGAInput'];
                    echo $this->_tpl_vars['LDA'];
                    ?>
                    &nbsp;&nbsp; <?php
                    echo $this->_tpl_vars['sBGBInput'];
                    echo $this->_tpl_vars['LDB'];
                    ?>
                    &nbsp;&nbsp; <?php
                echo $this->_tpl_vars['sBGABInput'];
                echo $this->_tpl_vars['LDAB'];
                    ?>
                    &nbsp;&nbsp; <?php
                echo $this->_tpl_vars['sBGOInput'];
                echo $this->_tpl_vars['LDO'];
                    ?>

                    &nbsp;&nbsp;
                    | <?php echo $this->_tpl_vars['RHfactor']; ?>
                    <?php
                    echo $this->_tpl_vars['sBRHposInput'];
                    echo $this->_tpl_vars['RHpos'];
                    ?>
                    &nbsp;&nbsp; <?php
                    echo $this->_tpl_vars['sBRHnegInput'];
                    echo $this->_tpl_vars['RHneg'];
                    ?>
...
<?php endif; ?>
            ...
            <tr>
                ...
                <td colspan=2 class="reg_input">
                    <?php
                    echo $this->_tpl_vars['sCSSingleInput'];
                    echo $this->_tpl_vars['LDSingle'];
                    ?>
                    &nbsp;&nbsp;
                    <?php
                    echo $this->_tpl_vars['sCSMarriedInput'];
                    echo $this->_tpl_vars['LDMarried'];
                    ?>
                    &nbsp;&nbsp;
                    <?php
                    echo $this->_tpl_vars['sCSDivorcedInput'];
                    echo $this->_tpl_vars['LDDivorced'];
                    ?>
                    &nbsp;&nbsp;
            <?php
            echo $this->_tpl_vars['sCSWidowedInput'];
            echo $this->_tpl_vars['LDWidowed'];
            ?>
                    &nbsp;&nbsp;
                    <?php
                    echo $this->_tpl_vars['sCSSeparatedInput'];
                    echo $this->_tpl_vars['LDSeparated'];
                    ?>
...
<?php echo $this->_tpl_vars['LDTribe']; ?>
    ...
    <?php
    if (count($_from = (array) $this->_tpl_vars['sInsClasses'])):
