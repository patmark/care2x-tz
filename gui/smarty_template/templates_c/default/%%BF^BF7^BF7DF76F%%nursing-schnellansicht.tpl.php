<?php /* Smarty version 2.6.22, created on 2017-07-17 00:37:38
...
<!--
    ...
    <?php endif; ?>
        ...
        if (e == 1)
            urlholder = "nursing-station-pass.php?rt=pflege&sid=<?php echo $this->_tpl_vars['SID_Parameter']; ?>
&edit=1&retpath=quick&ward_nr=" + ward_nr + "&station=" + st;
        else
            urlholder = "nursing-station.php?rt=pflege&sid=<?php echo $this->_tpl_vars['SID_Parameter']; ?>
