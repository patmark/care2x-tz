        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <!--<td class="adm_input"><input name="nr" cols=4 rows=1 wrap="physical">{{$ward_id}}</input></td>-->
                ...
                <tr>
                 ...
                 <tr>
                    <td class="adm_item">{{$LDPharmacy}}</td>
                    <td class="adm_input">{{$sPharmacySelectBox}} {{$sSelectIcon}} {{$LDPlsSelectPharm}}</td>
                </tr>
                <tr>
                    <td class="adm_item">{{$LDRoom1Nr}}</td>
                    <td class="adm_input"><input name="room_nr_start" cols=4 rows=1 wrap="physical" value="{{$room_nr_start}}"/></td>
                    <!--<td class="adm_input" colspan="2">{{$room_nr_start}}</td>-->
                </tr>
                <tr>
                    <td class="adm_item">{{$LDRoom2Nr}}</td>
                    <td class="adm_input"><input name="room_nr_end" cols=4 rows=1 wrap="physical" value="{{$room_nr_end}}"/></td>
                    <!--<td class="adm_input" colspan="2">{{$room_nr_end}}</td>-->
                </tr>
                <tr>
                    <td class="adm_item">{{$LDRoomPrefix}}</td>
                    <td class="adm_input"><input name="roomprefix" cols=4 rows=1 wrap="physical" value="{{$roomprefix}}"/></td>
